...
REM   ukbe-run-agent submit --workflow-name image_csv_gen_v3 ...
...
set "WORKFLOW_NAME=image_csv_gen_v3"
...
if not "!IMAGE_FOLDER!"=="" set "FLAGS=!FLAGS! --input IMAGE_FOLDER=!IMAGE_FOLDER!"
