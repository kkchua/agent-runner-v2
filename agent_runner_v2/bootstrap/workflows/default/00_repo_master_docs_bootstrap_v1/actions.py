...
from agent_runner_v2.constants import (
    ...
    ARTIFACT_KEY_RUNTIME_GOVERNANCE,
...
REPO_MASTER_DOC_REQUIRED_SECTIONS: dict[str, list[str]] = {
    ...
    repo_governance_rel("DOCUMENTATION_STANDARD.md"): [
        "Purpose",
        "Audience Model",
        "Document Set",
        "Update Triggers",
    ...
    repo_governance_rel("SYSTEM_OVERVIEW.md"): [
        "Purpose",
        "Scope",
        "Primary Flows",
        "Key Risks",
    ...
    repo_governance_rel("SYSTEM_FILE_STRUCTURE.md"): [
    ...
    repo_governance_rel("RUNBOOK.md"): [
        "Operations Scope",
        "Routine Procedures",
        "Failure Handling",
    ],
    repo_governance_rel("EXISTING_REPO_WORKFLOW_SOP.md"): [
        "Purpose",
        "First-Time Setup",
        ...
        checks.append(
            {
                ...
                "path": index_path,
                "ok": "DOCUMENTATION_STANDARD.md" in index_text,
                "detail": "present" if "DOCUMENTATION_STANDARD.md" in index_text else "missing",
            }
        )
        checks.append(
            {
                "check": "index_mentions_system_overview",
                "path": index_path,
                "ok": "SYSTEM_OVERVIEW.md" in index_text,
                "detail": "present" if "SYSTEM_OVERVIEW.md" in index_text else "missing",
            }
        )
    return checks
