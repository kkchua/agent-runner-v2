...
scan_policy: "include"
scan_reason: "Standard operating procedure defining workflow sequence, approval gates, naming conventions, and audit trail rules for SDLC delivery"
...
5. **stepCompletion** (action) -- Finalize and notify
