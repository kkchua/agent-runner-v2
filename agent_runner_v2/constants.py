...
# ============================================================================
# SDLC Folder Constants (AI-Driven Software Development Life Cycle)
# ============================================================================
# Semantic folder structure for AI-driven SDLC workflows.
# Groups artifacts by meaning, not by workflow step.
...
def get_master_docs_output_paths(job_id: str = "{job_id}", mode: str = "{mode}") -> dict[str, str]:
    ...
    return {
        ...
        ARTIFACT_KEY_SYSTEM_DOC_STANDARD: artifact_path(ARTIFACT_KEY_DOCUMENTATION_STANDARD, FOLDER_KEY_REPO_GOVERNANCE),
        ARTIFACT_KEY_BUNDLE_TAXONOMY: artifact_path(ARTIFACT_KEY_BUNDLE_TAXONOMY, FOLDER_KEY_REPO_GOVERNANCE),
        ARTIFACT_KEY_RUNTIME_GOVERNANCE: artifact_path(ARTIFACT_KEY_RUNTIME_GOVERNANCE, FOLDER_KEY_REPO_GOVERNANCE),
        ARTIFACT_KEY_BUNDLE_MIGRATION_PLAN: artifact_path(ARTIFACT_KEY_BUNDLE_MIGRATION_PLAN, FOLDER_KEY_REPO_GOVERNANCE),
        ARTIFACT_KEY_SYSTEM_OVERVIEW: artifact_path(ARTIFACT_KEY_SYSTEM_OVERVIEW, FOLDER_KEY_REPO_GOVERNANCE),
        ARTIFACT_KEY_BUSINESS_CAPABILITIES: artifact_path(ARTIFACT_KEY_BUSINESS_CAPABILITIES, FOLDER_KEY_REPO_GOVERNANCE),
        ARTIFACT_KEY_FUNCTIONAL_SPEC: artifact_path(ARTIFACT_KEY_FUNCTIONAL_SPEC, FOLDER_KEY_REPO_GOVERNANCE),
        ARTIFACT_KEY_NON_FUNCTIONAL_REQUIREMENTS: artifact_path(ARTIFACT_KEY_NON_FUNCTIONAL_REQUIREMENTS, FOLDER_KEY_REPO_GOVERNANCE),
        ARTIFACT_KEY_SYSTEM_CONTEXT: artifact_path(ARTIFACT_KEY_SYSTEM_CONTEXT, FOLDER_KEY_REPO_GOVERNANCE),
        ARTIFACT_KEY_COMPONENT_ARCHITECTURE: artifact_path(ARTIFACT_KEY_COMPONENT_ARCHITECTURE, FOLDER_KEY_REPO_GOVERNANCE),
        ARTIFACT_KEY_DECISION_LOG: artifact_path(ARTIFACT_KEY_DECISION_LOG, FOLDER_KEY_REPO_GOVERNANCE),
        ARTIFACT_KEY_SYSTEM_FILE_STRUCTURE: artifact_path(ARTIFACT_KEY_SYSTEM_FILE_STRUCTURE, FOLDER_KEY_REPO_GOVERNANCE),
        ARTIFACT_KEY_DEVELOPER_GUIDE: artifact_path(ARTIFACT_KEY_DEVELOPER_GUIDE, FOLDER_KEY_REPO_GOVERNANCE),
        ARTIFACT_KEY_RUNBOOK: artifact_path(ARTIFACT_KEY_RUNBOOK, FOLDER_KEY_REPO_GOVERNANCE),
        ARTIFACT_KEY_EXISTING_REPO_WORKFLOW_SOP: artifact_path(ARTIFACT_KEY_EXISTING_REPO_WORKFLOW_SOP, FOLDER_KEY_REPO_GOVERNANCE),
