@echo off
REM 00_layer1_governance_bootstrap_v1.bat - Edit the variables below, then run.
REM
REM Submits a new backend job for the 00_layer1_governance_bootstrap_v1workflow:
REM   ukbe-run-agent submit --workflow-name 00_layer1_governance_bootstrap_v1 ...
...
set "WORKFLOW_NAME=00_layer1_governance_bootstrap_v1"
