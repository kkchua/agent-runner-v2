...
| **Planned** | Implementation plan written, not yet built. |
...
| `sdlc_00_codebase_v1` | Layer 3 | **Planned** | Periodic codebase doc sync (maintenance workflow). Plan: [SDLC_00_CODEBASE_V1_PLAN.md](SDLC_00_CODEBASE_V1_PLAN.md). |
