@echo off
REM run-40_documentation_sync_v1.bat - Edit the variables below, then double-click (or run).
REM
REM Runs ukbe-run-agent for the 40_documentation_sync_v1 workflow:
REM   Reconcile repo-wide documentation against the current codebase.
REM
...
set "TEMPLATE_GROUP=40_documentation_sync_v1"

REM Path to the project to reconcile docs for
...
set "JOB_ID=40DOCSYNC-GEN-20260704-003"
