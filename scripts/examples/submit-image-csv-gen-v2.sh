#!/usr/bin/env bash
# Submit a run for: image_csv_gen_v2
#
# Purpose: Streamlined version of image_csv_gen_v1 — no review step.
#          Takes a folder of images and directly produces IMAGE_CSV_JSON + IMAGE_CSV_CSV.
#
