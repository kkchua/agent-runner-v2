#!/usr/bin/env bash
# run-02_agent_runner_platform_v1.sh - Edit the variables below, then run.
#
# Runs ukbe-run-agent for the 02_agent_runner_platform_v1 workflow:
#   Generates the Layer 2 platform constitution and governance docs.
...
TEMPLATE_GROUP="02_agent_runner_platform_v1"
JOB_ID=""
DRY_RUN="false"
NEW_JOB="false"
MODE="manual"
