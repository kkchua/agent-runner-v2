@echo off
REM submit-02_agent_runner_platform_v1.bat - Edit the variables below, then run.
REM
REM Submits a new backend job for the 02_agent_runner_platform_v1 workflow:
REM   ukbe-run-agent submit --workflow-name 02_agent_runner_platform_v1 ...
...
set "WORKFLOW_NAME=02_agent_runner_platform_v1"
set "INITIATIVE_ID="
