#!/usr/bin/env bash
# submit-00_bootstrap_lifecycle_admin_v1.sh - Edit the variables below, then run.
#
# Submits a new backend job for the 00_bootstrap_lifecycle_admin_v1 workflow:
#   ukbe-run-agent submit --workflow-name 00_bootstrap_lifecycle_admin_v1 ...
