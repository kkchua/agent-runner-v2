@echo off
REM submit-sdlc_00_codebase_v1.bat - Edit the variables below, then run.
REM
REM Submits a new backend job for the sdlc_00_codebase_v1 workflow:
REM   ukbe-run-agent submit --workflow-name sdlc_00_codebase_v1 ...
REM
REM This workflow syncs repository code to codebase documentation.
...
set "WORKFLOW_NAME=sdlc_00_codebase_v1"
