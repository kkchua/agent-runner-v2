#!/usr/bin/env bash
# run-01_governance_foundation_v1.sh - Edit the variables below, then run.
#
# Runs ukbe-run-agent for the 01_governance_foundation_v1 workflow:
#   Generates the master system documentation bundle for a target repo.
