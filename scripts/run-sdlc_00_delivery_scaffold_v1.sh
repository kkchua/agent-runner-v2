#!/usr/bin/env bash
# run-sdlc_00_delivery_scaffold_v1.sh - Edit the variables below, then run.
#
# Runs ukbe-run-agent for the sdlc_00_delivery_scaffold_v1 workflow:
#   Generates the SDLC delivery scaffold (templates + agent contracts).
