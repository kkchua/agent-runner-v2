#!/usr/bin/env bash
# run-00_bootstrap_lifecycle_admin_v1.sh - Edit the variables below, then run.
#
# Runs ukbe-run-agent for the 00_bootstrap_lifecycle_admin_v1 workflow:
#   Bootstraps the lifecycle admin governance foundation.
...
TEMPLATE_GROUP="00_bootstrap_lifecycle_admin_v1"
JOB_ID=""
DRY_RUN="false"
NEW_JOB="false"
MODE="manual"
