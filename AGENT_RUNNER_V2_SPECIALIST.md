...
Use [platform_context_manifest.json](D:/MyProjectSpace/01_Workflows/agent-runner-v2/platform_context_manifest.json) as the first lookup source for this repository.
...
1. update `platform_context_manifest.json`
2. keep this instruction file aligned with the manifest
