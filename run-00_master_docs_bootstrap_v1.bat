@echo off
REM run-00_master_docs_bootstrap_v1.bat - Edit the variables below, then double-click (or run).
REM
REM Runs ukbe-run-agent for the 00_master_docs_bootstrap_v1 workflow:
REM   Generate the master system documentation bundle for a target repo.
REM
...
set "JOB_ID=00DOC-GEN-20260704-001"
