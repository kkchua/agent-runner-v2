@echo off
REM run-41_stakeholder_doc_v1.bat - Generate stakeholder documentation markdown
REM
REM This workflow generates markdown content for the stakeholder documentation site.
...
set "TEMPLATE_GROUP=41_stakeholder_doc_v1"
...
set "JOB_ID=41STAKE-GEN-20260705-005"
