@echo off
REM run-54_tester_docs_v1.bat - Edit the variables below, then double-click (or run).
REM
REM Runs ukbe-run-agent for the 54_tester_docs_v1 workflow:
...
set "TEMPLATE_GROUP=54_tester_docs_v1"
