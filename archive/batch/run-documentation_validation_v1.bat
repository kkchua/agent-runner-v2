@echo off
REM run-documentation_validation_v1.bat - Edit the variables below, then double-click (or run).
REM
REM Runs ukbe-run-agent for the documentation_validation_v1 workflow.

setlocal enabledelayedexpansion

set "AGENT_RUNNER_ROOT=D:\MyProjectSpace\01_Workflows\agent-runner-v2"
set "TEMPLATE_GROUP=documentation_validation_v1"
