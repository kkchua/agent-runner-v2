@echo off
REM run-documentation_bootstrap_v1.bat - Edit the variables below, then double-click (or run).
REM
REM Runs ukbe-run-agent for the documentation_bootstrap_v1 workflow:
REM   Bootstrap codebase + system documentation from the current repository tree.
...
set "TEMPLATE_GROUP=documentation_bootstrap_v1"
