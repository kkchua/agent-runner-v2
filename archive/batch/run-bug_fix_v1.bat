@echo off
REM run-bug_fix_v1.bat - Edit the variables below, then double-click (or run).
REM
REM Runs ukbe-run-agent for the bug_fix_v1 workflow.

setlocal enabledelayedexpansion

set "AGENT_RUNNER_ROOT=D:\MyProjectSpace\01_Workflows\agent-runner-v2"
set "TEMPLATE_GROUP=bug_fix_v1"
...
set "FLAGS=--set BUG_DRAFT_FILE=!BUG_DRAFT_FILE!"
