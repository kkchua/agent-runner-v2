@echo off
REM submit-codebase_rescan_v1.bat - Edit the variables below, then run.
REM
REM Submits a new backend job for the codebase_rescan_v1 workflow:
REM   ukbe-run-agent submit --workflow-name codebase_rescan_v1 ...
...
set "WORKFLOW_NAME=codebase_rescan_v1"
