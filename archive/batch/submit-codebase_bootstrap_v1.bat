@echo off
REM submit-codebase_bootstrap_v1.bat - Edit the variables below, then run.
REM
REM Submits a new backend job for the codebase_bootstrap_v1 workflow:
REM   ukbe-run-agent submit --workflow-name codebase_bootstrap_v1 ...
REM
REM Typical workflow:
REM   1. Start a daemon with run-daemon.bat
REM   2. Edit the variables below
REM   3. Run this batch file to enqueue the codebase bootstrap job
...
set "WORKFLOW_NAME=codebase_bootstrap_v1"
