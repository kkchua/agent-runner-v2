@echo off
REM submit-documentation_bootstrap_v1.bat - Edit the variables below, then run.
REM
REM Submits a new backend job for the documentation_bootstrap_v1 workflow:
REM   ukbe-run-agent submit --workflow-name documentation_bootstrap_v1 ...
...
set "WORKFLOW_NAME=documentation_bootstrap_v1"
