@echo off
REM run-codebase_rescan_v1.bat - Edit the variables below, then double-click (or run).
REM
REM Runs ukbe-run-agent for the codebase_rescan_v1 workflow:
REM   Re-scan an existing repository and reconcile docs/codebase drift.
...
set "TEMPLATE_GROUP=codebase_rescan_v1"
