@echo off
REM run-41_tester_doc_v1.bat - Generate tester documentation markdown
REM
REM This workflow generates markdown content for the tester documentation site.
...
set "TEMPLATE_GROUP=41_tester_doc_v1"
...
set "JOB_ID=41TEST-GEN-20260705-001"
