@echo off
REM run-51_stakeholder_docs_v1.bat - Edit the variables below, then double-click (or run).
REM
REM Runs ukbe-run-agent for the 51_stakeholder_docs_v1 workflow:
...
set "TEMPLATE_GROUP=51_stakeholder_docs_v1"
...
set "JOB_ID=51STAKE-GEN-20260705-010"
