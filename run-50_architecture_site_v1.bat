@echo off
REM run-50_architecture_site_v1.bat - Edit the variables below, then double-click (or run).
REM
REM Runs ukbe-run-agent for the 50_architecture_site_v1 workflow:
...
set "TEMPLATE_GROUP=50_architecture_site_v1"
...
set "JOB_ID=50SITE-GEN-20260705-003"
