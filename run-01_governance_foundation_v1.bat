@echo off
REM run-01_governance_foundation_v1.bat - Edit the variables below, then double-click (or run).
REM
REM Runs ukbe-run-agent for the 01_governance_foundation_v1 workflow (plugin package):
REM   Generates the master system documentation bundle for a target repo.
REM   Loads the workflow definition from workflows/01_governance_foundation_v1/workflow.toml.
REM
