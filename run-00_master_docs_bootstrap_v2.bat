@echo off
REM run-00_master_docs_bootstrap_v2.bat - Edit the variables below, then double-click (or run).
REM
REM Runs ukbe-run-agent for the 00_master_docs_bootstrap_v2 workflow (plugin package):
REM   Generates the master system documentation bundle for a target repo.
REM   Loads the workflow definition from workflows/00_master_docs_bootstrap_v2/workflow.toml.
REM
...
set "JOB_ID=00DOC-GEN-20260710-001"
