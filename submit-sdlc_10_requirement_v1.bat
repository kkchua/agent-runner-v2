@echo off
REM submit-sdlc_10_requirement_v1.bat - Edit the variables below, then run.
REM
REM Submits a new backend job for the sdlc_10_requirement_v1 workflow:
REM   ukbe-run-agent submit --workflow-name sdlc_10_requirement_v1 ...
REM
REM This workflow generates structured requirements from approved initiative,
REM producing an approved REQ_FILE document.
...
set "WORKFLOW_NAME=sdlc_10_requirement_v1"
set "INITIATIVE_ID="
...
set "INIT_FILE=INIT-20260723-001_console-sdlc10-support.md"
...
if not "!INIT_FILE!"=="" (
    ...
    set "INPUT_FLAGS=--input INIT_FILE=!INIT_PATH!"
)
