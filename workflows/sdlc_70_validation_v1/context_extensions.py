...
This module provides workflow-specific context variables for the validation
...
def build_context_extensions(
    *,
    ...
    """Build context extensions for sdlc_70_validation_v1 workflow.

    This function provides additional context variables needed by the
    validation workflow prompts, including:
    - Layer 1 governance runtime root
    - Layer 2 platform runtime root
    - Codebase documentation root
    - SDLC delivery root and validation-specific subdirectories
    ...
    if workspace_root:
        ...
        val_dir = sdlc_delivery_root / "validations"
        result["VAL_DIR"] = str(val_dir)
