"""Context extensions for AR Meta Builder v1.
...
class ArMetaBuilderV1Extensions(WorkflowExtensions):
    """Artifact key registration and path resolution for AR Meta Builder v1.
