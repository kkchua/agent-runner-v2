...
spec_reference: "ar_meta_builder_v1.md"
...
# Composition Standard -- AR_META_BUILDER_STANDARD v1.0.0

## Overview

This document defines the composition standard for the
ar_meta_builder domain. It is the key v3 innovation: every generated
...
input specification (WORKFLOW_SPEC_FILE: ar_meta_builder_v1.md) and
...
ar_meta_builder domain. It specifies the 8 component types that
...
| Property | Type | Required | Description |
|---|---|---|---|
| standard_name | string | Yes | Name of the composition standard (e.g., "AR_META_BUILDER_STANDARD"). |
...
```yaml
- component_id: "standard-ar_meta_builder-01"
  component_type: "composition_standard"
  name: "AR Meta Builder Standard"
  version: "1.0.0"
  description: "The composition standard for the ar_meta_builder domain defining all component types and schema layers"
  standard_name: "AR_META_BUILDER_STANDARD"
  standard_version: "1.0.0"
  component_types_defined:
    - "step_definition"
...
ar_meta_builder domain. It specifies how the 8 component types from
...
Every composition for the ar_meta_builder domain is a YAML document
...
ar_meta_builder domain. It specifies how compositions materialize
...
| standard_name | from spec | "AR_META_BUILDER_STANDARD" | PASS |
...
| TC-072 | PASS | standard_name = "AR_META_BUILDER_STANDARD" in frontmatter |
