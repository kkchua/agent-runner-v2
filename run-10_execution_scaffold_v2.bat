@echo off
REM run-10_execution_scaffold_v1.bat - Edit the variables below, then double-click (or run).
REM
REM Runs ukbe-run-agent for the 10_execution_scaffold_v1 workflow:
REM   Bootstrap delivery SOPs, templates, and agent contracts into a target repo.
REM
...
set "TEMPLATE_GROUP=10_execution_scaffold_v2"

REM Path to the project to scaffold delivery docs into
