@echo off
REM run-00_layer1_governance_bootstrap_v1.bat - Edit the variables below, then double-click (or run).
REM
REM Runs ukbe-run-agent for the 00_layer1_governance_bootstrap_v1 workflow (plugin package):
REM   Generates the master system documentation bundle for a target repo.
REM   Loads the workflow definition from workflows/00_layer1_governance_bootstrap_v1/workflow.toml.
REM
...
set "TEMPLATE_GROUP=00_layer1_governance_bootstrap_v1"
...
set "JOB_ID=00L1-GEN-20260715-010"
