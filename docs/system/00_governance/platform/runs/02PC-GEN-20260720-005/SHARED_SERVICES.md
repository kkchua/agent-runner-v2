...
- `complete_step_run()`: reports step completion and artifact paths.
- `heartbeat()`: emits liveness heartbeats for active runs.
- `approve_run()`: records human approval decisions.
