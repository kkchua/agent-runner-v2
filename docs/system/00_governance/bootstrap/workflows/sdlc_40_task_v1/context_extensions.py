...
This module provides workflow-specific context variables for the task
...
def build_context_extensions(
    *,
    ...
    if workspace_root:
        ...
        # Tasks directory
        task_dir = sdlc_delivery_root / "tasks"
