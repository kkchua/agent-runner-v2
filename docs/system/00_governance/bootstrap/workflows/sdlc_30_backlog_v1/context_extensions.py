...
This module provides workflow-specific context variables for the backlog
...
def build_context_extensions(
    *,
    ...
    if workspace_root:
        ...
        # Backlogs directory
        backlog_dir = sdlc_delivery_root / "backlogs"
        result["BACKLOG_DIR"] = str(backlog_dir)
