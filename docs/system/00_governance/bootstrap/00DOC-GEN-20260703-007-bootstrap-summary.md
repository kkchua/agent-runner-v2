...
- Job ID: `00DOC-GEN-20260703-007`
- Mode: `bootstrap`
- Workflow: `00_master_docs_bootstrap_v1`

## Outputs

- `CODEBASE_SCAN_SNAPSHOT`: `docs/codebase/04_changes/00DOC-GEN-20260703-007-bootstrap-snapshot.json`
- `CODEBASE_CHANGE_IMPACT`: `docs/codebase/04_changes/00DOC-GEN-20260703-007-bootstrap.md`
...
- `VALIDATION_FILE`: `docs/codebase/04_changes/00DOC-GEN-20260703-007-bootstrap-validation.md`
- `SYSTEM_DOCS_VALIDATION`: `docs/system/00_governance/bootstrap/00DOC-GEN-20260703-007-bootstrap-validation.md`
