...
| `docs/codebase/04_changes/00DOC-GEN-20260702-005-bootstrap-snapshot.json` | modify | part of repository scan baseline | medium |
...
| `agent-runner-v2-actions-execute-t2i.md` | undocumented | current | `docs/codebase/02_modules/agent-runner-v2-actions-execute-t2i.md` |
