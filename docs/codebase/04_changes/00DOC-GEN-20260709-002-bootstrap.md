...
|------|-------------|-------------|--------|
| `.claude/settings.local.json` | modify | part of repository scan baseline | medium |
| `.env.example` | modify | part of repository scan baseline | medium |
| `.pytest-temp/test_build_snapshot_excludes_t0/README.md` | modify | part of repository scan baseline | medium |
| `.pytest-temp/test_cleanup_identifies_legacy0/docs/system/00_governance/bootstrap/README.md` | modify | part of repository scan baseline | medium |
| `.pytest-temp/test_cleanup_identifies_legacy0/docs/system/README.md` | modify | part of repository scan baseline | medium |
| `.pytest-temp/test_finalize_bootstrap_uses_s0/docs/codebase/01_inventory/codebase_inventory.md` | modify | part of repository scan baseline | medium |
| `.pytest-temp/test_finalize_bootstrap_uses_s0/docs/codebase/04_changes/00DOC-GEN-TEST-bootstrap-snapshot.json` | modify | part of repository scan baseline | medium |
| `.pytest-temp/test_finalize_bootstrap_uses_s0/docs/codebase/04_changes/00DOC-GEN-TEST-bootstrap-validation.md` | modify | part of repository scan baseline | medium |
| `.pytest-temp/test_finalize_bootstrap_uses_s0/docs/codebase/04_changes/00DOC-GEN-TEST-bootstrap.md` | modify | part of repository scan baseline | medium |
| `.pytest-temp/test_finalize_bootstrap_uses_s0/docs/system/00_governance/bootstrap/00DOC-GEN-TEST-bootstrap-change-log.md` | modify | part of repository scan baseline | medium |
| `.pytest-temp/test_finalize_bootstrap_uses_s0/docs/system/00_governance/bootstrap/00DOC-GEN-TEST-bootstrap-summary.md` | modify | part of repository scan baseline | medium |
| `.pytest-temp/test_finalize_bootstrap_uses_s0/docs/system/00_governance/bootstrap/00DOC-GEN-TEST-bootstrap-validation.md` | modify | part of repository scan baseline | medium |
| `.pytest-temp/test_finalize_bootstrap_uses_s0/docs/system/00_governance/bootstrap/meta.json` | modify | part of repository scan baseline | medium |
| `.pytest-temp/test_finalize_bootstrap_uses_s0/docs/system/00_governance/bootstrap/project_analysis.md` | modify | part of repository scan baseline | medium |
| `.pytest-temp/test_finalize_bootstrap_uses_s0/docs/system/00_governance/bootstrap/README.md` | modify | part of repository scan baseline | medium |
| `.pytest-temp/test_html_files_are_classified0/docs/site/architecture/index.html` | modify | part of repository scan baseline | medium |
| `.pytest-temp/test_init_workspace_auto_publi0/package/bootstrap/bundles/core/current/README.md` | modify | part of repository scan baseline | medium |
| `.pytest-temp/test_init_workspace_auto_publi0/workspace/docs/system/00_governance/bootstrap/README.md` | modify | part of repository scan baseline | medium |
| `.pytest-temp/test_init_workspace_installs_p0/package/bootstrap/bundles/core/current/README.md` | modify | part of repository scan baseline | medium |
| `.pytest-temp/test_publish_bootstrap_bundle_0/package/bootstrap/bundles/core/current/README.md` | modify | part of repository scan baseline | medium |
| `.pytest-temp/test_publish_bootstrap_bundle_0/package/bootstrap/bundles/core/current/templates/delivery/01_delivery_template_registry.md` | modify | part of repository scan baseline | medium |
| `.pytest-temp/test_publish_bootstrap_bundle_0/workspace/docs/system/00_governance/bootstrap/README.md` | modify | part of repository scan baseline | medium |
| `.pytest-temp/test_publish_bootstrap_bundle_0/workspace/docs/system/00_governance/bootstrap/templates/delivery/01_delivery_template_registry.md` | modify | part of repository scan baseline | medium |
| `.pytest-temp/test_qwen_sidecar_validity_sho0/meta.json` | modify | part of repository scan baseline | medium |
| `.pytest-temp/test_step_runner_repairs_missi0/meta.json` | modify | part of repository scan baseline | medium |
| `.pytest-temp/test_step_runner_repairs_plain0/meta.json` | modify | part of repository scan baseline | medium |
| `.pytest-temp/test_write_meta_sidecar_resolv0/workspace/docs/delivery/01_initiatives/meta.json` | modify | part of repository scan baseline | medium |
| `.qwen/pending-skills/34e32c14-f817-4043-a8fb-73bd40833899/auto-skill-generate-integration-map/SKILL.md` | modify | part of repository scan baseline | medium |
| `.qwen/pending-skills/5b002c5e-45f7-44ec-9b6b-d8ae07798ec6/auto-skill-declarative-doc-protection/SKILL.md` | modify | part of repository scan baseline | medium |
| `.qwen/pending-skills/619c4224-1631-4571-a8cf-290583ea85f0/auto-skill-review-stakeholder-docs/SKILL.md` | modify | part of repository scan baseline | medium |
| `.qwen/pending-skills/ba0e736a-3145-4e6e-811f-c149c8292827/auto-skill-generate-failure-modes/SKILL.md` | modify | part of repository scan baseline | medium |
| `.qwen/settings.json` | modify | part of repository scan baseline | medium |
| `.qwen/skills/auto-skill-agent-system-review/SKILL.md` | modify | part of repository scan baseline | medium |
| `.qwen/skills/auto-skill-centralized-path-constants/SKILL.md` | modify | part of repository scan baseline | medium |
| `.qwen/skills/auto-skill-centralized-section-requirements/SKILL.md` | modify | part of repository scan baseline | medium |
| `.qwen/skills/auto-skill-fetch-github-issue-for-bug-fix/SKILL.md` | modify | part of repository scan baseline | medium |
...
| `.qwen/skills/auto-skill-prompt-sidecar-injection/SKILL.md` | modify | part of repository scan baseline | medium |
| `.qwen/skills/auto-skill-refactor-validate-delivery-docs-constants/SKILL.md` | modify | part of repository scan baseline | medium |
| `.qwen/skills/auto-skill-review-master-system-docs/SKILL.md` | modify | part of repository scan baseline | medium |
| `.qwen/skills/auto-skill-workflow-execution-documentation/SKILL.md` | modify | part of repository scan baseline | medium |
| `.qwen/skills/draft-initiative-pre-init/Skill.md` | modify | part of repository scan baseline | medium |
| `.qwen/skills/fetch-github-issue-for-bug-fix/SKILL.md` | modify | part of repository scan baseline | medium |
...
| `agent_runner_v2/bootstrap/bundles/core/current/00DOC-GEN-20260709-001-bootstrap-change-log.md` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/bundles/core/current/00DOC-GEN-20260709-001-bootstrap-summary.md` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/bundles/core/current/00DOC-GEN-20260709-001-bootstrap-validation.md` | modify | part of repository scan baseline | medium |
...
| `agent_runner_v2/bootstrap/bundles1/core/current/00DOC-20260708-45730d62-bootstrap-change-log.md` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/bundles1/core/current/00DOC-20260708-45730d62-bootstrap-validation.md` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/bundles1/core/current/00DOC-20260708-45730d62-bootstrap-validation.meta.json` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/bundles1/core/current/00DOC-20260708-78fb419e-bootstrap-change-log.md` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/bundles1/core/current/00DOC-20260708-78fb419e-bootstrap-summary.md` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/bundles1/core/current/00DOC-20260708-78fb419e-bootstrap-validation.md` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/bundles1/core/current/AGENT-EXECUTOR.md` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/bundles1/core/current/AGENT-IMPL-PLANNER.md` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/bundles1/core/current/AGENT-MEMORY-MANAGER.md` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/bundles1/core/current/AGENT-PLANNER.md` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/bundles1/core/current/AGENT-REVIEWER.md` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/bundles1/core/current/AGENT-TASK-DECOMPOSER.md` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/bundles1/core/current/AGENTS.md` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/bundles1/core/current/BUNDLE_MIGRATION_PLAN.md` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/bundles1/core/current/BUNDLE_TAXONOMY.md` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/bundles1/core/current/BUSINESS_CAPABILITIES.md` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/bundles1/core/current/COMPONENT_ARCHITECTURE.md` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/bundles1/core/current/DECISION_LOG.md` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/bundles1/core/current/DELIVERY_STATUS_RULES.md` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/bundles1/core/current/DELIVERY_STATUS_RULES_v1.md` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/bundles1/core/current/DEVELOPER_GUIDE.md` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/bundles1/core/current/DOCUMENTATION_STANDARD.md` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/bundles1/core/current/EXISTING_REPO_WORKFLOW_SOP.md` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/bundles1/core/current/FUNCTIONAL_SPEC.md` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/bundles1/core/current/NON_FUNCTIONAL_REQUIREMENTS.md` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/bundles1/core/current/PROJECT_ANALYSIS.md` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/bundles1/core/current/README.md` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/bundles1/core/current/RUNBOOK.md` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/bundles1/core/current/SYSTEM_CONTEXT.md` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/bundles1/core/current/SYSTEM_FILE_STRUCTURE.md` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/bundles1/core/current/SYSTEM_OVERVIEW.md` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/bundles1/core/current/templates/codebase/01_codebase_template_registry.md` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/bundles1/core/current/templates/codebase/02_codebase_inventory_template.md` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/bundles1/core/current/templates/codebase/03_codebase_module_template.md` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/bundles1/core/current/templates/codebase/04_codebase_component_template.md` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/bundles1/core/current/templates/codebase/05_codebase_change_template.md` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/bundles1/core/current/templates/delivery/01_delivery_template_registry.md` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/bundles1/core/current/templates/delivery/02_delivery_initiative_template.md` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/bundles1/core/current/templates/delivery/03_delivery_plan_template.md` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/bundles1/core/current/templates/delivery/04_delivery_task_graph_template.md` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/bundles1/core/current/templates/delivery/05_delivery_task_template.md` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/bundles1/core/current/templates/delivery/06_delivery_impl_template.md` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/bundles1/core/current/templates/delivery/07_delivery_review_template.md` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/bundles1/core/current/templates/delivery/08_delivery_validation_template.md` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/bundles1/core/current/templates/delivery/09_delivery_memory_template.md` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/bundles1/core/current/WORKFLOW_SOP_v1.md` | modify | part of repository scan baseline | medium |
...
| `docs/codebase/04_changes/00DOC-GEN-20260709-002-bootstrap-snapshot.json` | modify | part of repository scan baseline | medium |
