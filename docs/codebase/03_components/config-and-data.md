...
modules: [".env.example", "agent_runner_v2/comfyui_config.json", "agent_runner_v2/job_schema.json", "agent_runner_v2/llm_response_schema.json", "agent_runner_v2/model_mapping.json", "agent_runner_v2/usage_schema.json", "docs/codebase/04_changes/00DOC-GEN-20260702-005-bootstrap-snapshot.json", "pyproject.toml"]
---
...
| `docs/codebase/04_changes/00DOC-GEN-20260702-005-bootstrap-snapshot.json` | configuration / structured data |
...
| `docs/codebase/04_changes/00DOC-GEN-20260702-005-bootstrap-snapshot.json` | outbound | markdown | configuration / structured data |
...
|------|--------|-----------------|-------------|
| 2026-07-02 | Initial baseline generated from repository scan | 8 modules/files | 00_master_docs_bootstrap_v1 |
