---
title: "Module Documentation: agent_runner_v2.actions.publish_architecture_site"
template_id: "CB-02"
status: "active"
module_path: "agent_runner_v2/actions/publish_architecture_site.py"
module_area: "actions"
documentation_mode: "full"
owner_doc_path: "docs/codebase/02_modules/agent-runner-v2-actions-publish-architecture-site.md"
...
# Module Documentation: agent_runner_v2.actions.publish_architecture_site
...
|----------|-----------|---------|
| `publish_architecture_site` | `()` | public function |
...
|-----------|--------------|
| `tests/test_architecture_site.py` | `agent_runner_v2.actions.publish_architecture_site` |
| `tests/test_documentation_governance.py` | `agent_runner_v2.actions.publish_architecture_site` |
