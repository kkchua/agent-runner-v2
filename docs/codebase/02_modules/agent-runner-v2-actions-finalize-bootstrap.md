---
title: "Module Documentation: agent_runner_v2.actions.finalize_bootstrap"
template_id: "CB-02"
status: "active"
module_path: "agent_runner_v2/actions/finalize_bootstrap.py"
module_area: "actions"
documentation_mode: "full"
owner_doc_path: "docs/codebase/02_modules/agent-runner-v2-actions-finalize-bootstrap.md"
...
# Module Documentation: agent_runner_v2.actions.finalize_bootstrap
...
|----------|-----------|---------|
| `finalize_bootstrap` | `()` | public function |
...
|-----------|--------------|
| `tests/test_bundle_loader.py` | `agent_runner_v2.actions.finalize_bootstrap` |
| `tests/test_documentation_governance.py` | `agent_runner_v2.actions.finalize_bootstrap` |
