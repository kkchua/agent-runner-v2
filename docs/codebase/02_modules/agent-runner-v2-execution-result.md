---
title: "Module Documentation: agent_runner_v2.execution_result"
template_id: "CB-02"
status: "active"
module_path: "agent_runner_v2/execution_result.py"
module_area: "state"
documentation_mode: "summary"
owner_doc_path: "docs/codebase/02_modules/agent-runner-v2-execution-result.md"
...
# Module Documentation: agent_runner_v2.execution_result
...
This module belongs to the `state` area and is documented as `summary`.
...
|-------|---------|-------------|
| `ExecutionFailure` | public class | |
| `ExecutionResult` | public class | |
...
|-----------|--------------|
| `tests/test_backend_worker_mode.py` | `agent_runner_v2.execution_result` |
