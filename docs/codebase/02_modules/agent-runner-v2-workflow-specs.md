...
|----------|-----------|---------|
| `load_workflow_definition` | `()` | public function |
| `get_template_group_cfg` | `()` | public function |
| `build_step_execution_spec` | `()` | public function |
| `build_workflow_step_specs` | `()` | public function |
| `reconcile_step_execution_spec` | `()` | public function |

### 2.3 Constants / Configuration

| Name | Value / Type | Purpose |
|------|-------------|---------|
| `AUTHORITATIVE_STEP_SPEC_KEYS` | constant | module configuration |
