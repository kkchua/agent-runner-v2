...
owner_doc_path: "docs/codebase/02_modules/agent-runner-v2-actions-sync-system-docs.md"
...
|----------|-----------|---------|
| `sync_system_docs` | `()` | public function |
...
|-----------|--------------|
| `tests/test_bundle_loader.py` | `agent_runner_v2.actions.sync_system_docs` |
