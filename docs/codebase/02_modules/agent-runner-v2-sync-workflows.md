...
owner_doc_path: "docs/codebase/02_modules/agent-runner-v2-sync-workflows.md"
...
| `bootstrap.workflows.default.template_groups` | external module | repository dependency |
