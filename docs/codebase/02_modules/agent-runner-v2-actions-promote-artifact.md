---
title: "Module Documentation: agent_runner_v2.actions.promote_artifact"
template_id: "CB-02"
status: "active"
module_path: "agent_runner_v2/actions/promote_artifact.py"
module_area: "actions"
documentation_mode: "full"
owner_doc_path: "docs/codebase/02_modules/agent-runner-v2-actions-promote-artifact.md"
...
# Module Documentation: agent_runner_v2.actions.promote_artifact
...
|----------|-----------|---------|
| `promote_artifact` | `()` | public function |

### 2.3 Constants / Configuration

| Name | Value / Type | Purpose |
|------|-------------|---------|
| `_TABLE_STATUS_RE` | constant | module configuration |
| `_KV_STATUS_RE` | constant | module configuration |
...
|-----------|--------------|
| `tests/test_backend_worker_mode.py` | `agent_runner_v2.actions.promote_artifact` |
