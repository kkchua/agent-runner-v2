...
|----------|-----------|---------|
| `render_architecture_site` | `(snapshot, project_root)` | public function |

### 2.3 Constants / Configuration

| Name | Value / Type | Purpose |
|------|-------------|---------|
| `SITE_ROOT` | constant | module configuration |
| `SITE_PAGES` | constant | module configuration |
...
|-----------|--------------|
| `tests/test_architecture_site.py` | `agent_runner_v2.architecture_site` |
| `tests/test_documentation_governance.py` | `agent_runner_v2.architecture_site` |
