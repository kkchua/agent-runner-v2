---
title: "Module Documentation: agent_runner_v2.actions.scan_repo_codebase"
template_id: "CB-02"
status: "active"
module_path: "agent_runner_v2/actions/scan_repo_codebase.py"
module_area: "actions"
documentation_mode: "full"
owner_doc_path: "docs/codebase/02_modules/agent-runner-v2-actions-scan-repo-codebase.md"
...
# Module Documentation: agent_runner_v2.actions.scan_repo_codebase
...
|----------|-----------|---------|
| `scan_repo_codebase` | `()` | public function |
...
|-----------|--------------|
| `tests/test_bundle_loader.py` | `agent_runner_v2.actions.scan_repo_codebase` |
| `tests/test_codebase_docs.py` | `agent_runner_v2.actions.scan_repo_codebase` |
