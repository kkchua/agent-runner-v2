...
|----------|-----------|---------|
| `validate_delivery_docs` | `()` | Validate the complete delivery documentation scaffold. |

### 2.3 Constants / Configuration

| Name | Value / Type | Purpose |
|------|-------------|---------|
| `DELIVERY_FOLDERS` | constant | module configuration |
| `DELIVERY_TEMPLATE_ROOT` | constant | module configuration |
| `CODEBASE_TEMPLATE_ROOT` | constant | module configuration |
| `DELIVERY_AGENT_ROOT` | constant | module configuration |
| `REQUIRED_TEMPLATES` | constant | module configuration |
| `REQUIRED_CODEBASE_FILES` | constant | module configuration |
| `REQUIRED_SYSTEM_FILES` | constant | module configuration |
| `SOP_REQUIRED_SECTIONS` | constant | module configuration |
| `STATUS_RULES_REQUIRED_SECTIONS` | constant | module configuration |
| `CODEBASE_SOP_REQUIRED_SECTIONS` | constant | module configuration |
| `CODEBASE_STATUS_RULES_REQUIRED_SECTIONS` | constant | module configuration |
| `AGENT_REGISTRY_ENTRY_PATTERN` | constant | module configuration |
...
|-----------|--------------|
| `tests/test_bundle_loader.py` | `agent_runner_v2.actions.validate_delivery_docs` |
| `tests/test_documentation_governance.py` | `agent_runner_v2.actions.validate_delivery_docs` |
