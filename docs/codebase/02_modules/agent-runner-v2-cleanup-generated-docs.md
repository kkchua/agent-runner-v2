...
|-------|---------|-------------|
| `CleanupResult` | public class | |

### 2.2 Functions

| Function | Signature | Purpose |
|----------|-----------|---------|
| `cleanup_workflow_generated_docs` | `()` | public function |
...
|-----------|--------------|
| `tests/test_documentation_guardrails_cleanup.py` | `agent_runner_v2.cleanup_generated_docs` |
