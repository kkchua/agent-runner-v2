---
title: "Module Documentation: agent_runner_v2.actions.validate_codebase_docs"
template_id: "CB-02"
status: "active"
module_path: "agent_runner_v2/actions/validate_codebase_docs.py"
module_area: "actions"
documentation_mode: "full"
owner_doc_path: "docs/codebase/02_modules/agent-runner-v2-actions-validate-codebase-docs.md"
...
# Module Documentation: agent_runner_v2.actions.validate_codebase_docs
...
|----------|-----------|---------|
| `validate_codebase_docs` | `()` | public function |
...
|-----------|--------------|
| `tests/test_bundle_loader.py` | `agent_runner_v2.actions.validate_codebase_docs` |
| `tests/test_documentation_governance.py` | `agent_runner_v2.actions.validate_codebase_docs` |
