...
class AgnesMediaGenExtensions(WorkflowExtensions):
    ...
    def register_artifact_keys(
        ...
        *,
        ...
        All paths are relative to the target repository root. These
        represent the index.json files produced by each processing step.
    ...
    def build_context_extensions(
        ...
        *,
        ...
        # Resolve artifact paths from register_artifact_keys() to absolute
