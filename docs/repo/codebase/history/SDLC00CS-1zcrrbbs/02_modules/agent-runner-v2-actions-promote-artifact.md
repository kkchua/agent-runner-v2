...
owner_doc_path: "docs/repo/codebase/current/02_modules/agent-runner-v2-actions-promote-artifact.md"
...
| Name | Purpose |
|------|--------|
| `_TABLE_STATUS_RE` | module configuration |
| `_KV_STATUS_RE` | module configuration |
| `_FRONTMATTER_RE` | module configuration |
