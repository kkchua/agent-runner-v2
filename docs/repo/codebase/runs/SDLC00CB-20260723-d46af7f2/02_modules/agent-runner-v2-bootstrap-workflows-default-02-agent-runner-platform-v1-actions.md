---
title: "Module Documentation: agent_runner_v2.bootstrap.workflows.default.02_agent_runner_platform_v1.actions"
template_id: "CB-02"
version: "1.0.0"
doc_type: "system"
...
module_path: "agent_runner_v2/bootstrap/workflows/default/02_agent_runner_platform_v1/actions.py"
module_area: "support"
documentation_mode: "summary"
owner_doc_path: "docs/repo/codebase/current/02_modules/agent-runner-v2-bootstrap-workflows-default-02-agent-runner-platform-v1-actions.md"
...
# Module Documentation: agent_runner_v2.bootstrap.workflows.default.02_agent_runner_platform_v1.actions
...
**Signature**: `collect_platform_context(*, context: dict[str, str], state: dict, step_cfg: dict, project_root: Path)`
...
#### validate_platform_core_docs()

**Decorators**: `@action`

**Signature**: `validate_platform_core_docs(*, context: dict[str, str], state: dict, step_cfg: dict, project_root: Path)`
...
#### publish_platform_core_set()

**Decorators**: `@action`

**Signature**: `publish_platform_core_set(*, context: dict[str, str], state: dict, step_cfg: dict, project_root: Path)`
