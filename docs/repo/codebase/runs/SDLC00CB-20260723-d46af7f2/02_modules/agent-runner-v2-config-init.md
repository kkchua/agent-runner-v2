...
module_path: "agent_runner_v2/config/__init__.py"
module_area: "package"
documentation_mode: "stub"
owner_doc_path: "docs/repo/codebase/current/02_modules/agent-runner-v2-config-init.md"
...
|------------|------|---------|
| `section_requirements` | external module | repository dependency |
