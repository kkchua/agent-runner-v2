...
**Signature**: `sanitize_ascii(text: str)`

**Purpose**: Replace common non-ASCII characters with ASCII equivalents.

**Parameters**:

| Name | Type | Default | Description |
|------|------|---------|-------------|
| `text` | `str` | -- | Input text that may contain non-ASCII characters. |
...
**Signature**: `sanitize_ascii_file(file_path: str)`

**Purpose**: Read a Markdown file, sanitize non-ASCII characters, and write it back.

**Parameters**:

| Name | Type | Default | Description |
|------|------|---------|-------------|
| `file_path` | `str` | -- | Path to the .md file to sanitize. |
