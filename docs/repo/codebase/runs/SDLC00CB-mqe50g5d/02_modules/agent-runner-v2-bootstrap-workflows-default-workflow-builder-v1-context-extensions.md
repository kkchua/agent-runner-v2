---
title: "Module Documentation: agent_runner_v2.bootstrap.workflows.default.workflow_builder_v1.context_extensions"
template_id: "CB-02"
version: "1.0.0"
doc_type: "system"
...
module_path: "agent_runner_v2/bootstrap/workflows/default/workflow_builder_v1/context_extensions.py"
module_area: "bootstrap"
documentation_mode: "summary"
owner_doc_path: "docs/repo/codebase/current/02_modules/agent-runner-v2-bootstrap-workflows-default-workflow-builder-v1-context-extensions.md"
...
# Module Documentation: agent_runner_v2.bootstrap.workflows.default.workflow_builder_v1.context_extensions
...
**Purpose**: Workflow extension hooks for workflow_builder_v1.

**Methods**:

- `register_artifact_keys(*, job_id: str = '{job_id}', mode: str = '{mode}')` -> `dict[str, str]` -- Return artifact key to relative-path mappings.
- `build_context_extensions(*, state, step, step_cfg, ctx, project_root = None)` -> `dict[str, str]` -- Inject absolute paths and metadata into prompt context.
