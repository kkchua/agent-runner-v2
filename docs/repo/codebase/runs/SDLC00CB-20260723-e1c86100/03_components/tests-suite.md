...
modules: ["tests/conftest.py", "tests/integration/__init__.py", "tests/integration/test_architecture_site.py", "tests/integration/test_backend_worker_mode.py", "tests/integration/test_daemon.py", "tests/integration/test_notification_e2e.py", "tests/integration/test_notification_integration.py", "tests/integration/test_notifications.py", "tests/integration/test_pushover.py", "tests/integration/test_ukbe_runner_wrapper.py", "tests/run_workflow_unit_tests.py", "tests/unit/__init__.py", "tests/unit/test_agent_tools.py", "tests/unit/test_backend_execution.py", "tests/unit/test_bundle_loader.py", "tests/unit/test_codebase_docs.py", "tests/unit/test_codebase_init_commands.py", "tests/unit/test_coder_adapters_opencode.py", "tests/unit/test_coder_adapters_sidecar_grace.py", "tests/unit/test_constants_registry.py", "tests/unit/test_context_extensions.py", "tests/unit/test_daemon_runtime.py", "tests/unit/test_daemon_worker_payload.py", "tests/unit/test_documentation_governance.py", "tests/unit/test_documentation_guardrails_cleanup.py", "tests/unit/test_execution_core.py", "tests/unit/test_failure_runtime.py", "tests/unit/test_generated_doc_frontmatter_injection.py", "tests/unit/test_job_state_review_completion.py", "tests/unit/test_job_state_step_dirs.py", "tests/unit/test_job_state_usage_summary.py", "tests/unit/test_machine_contracts.py", "tests/unit/test_manual_runtime.py", "tests/unit/test_model_config_roles.py", "tests/unit/test_notification_manager.py", "tests/unit/test_operator_console_config.py", "tests/unit/test_operator_console_services.py", "tests/unit/test_plugin_workflow_support.py", "tests/unit/test_promote_artifact.py", "tests/unit/test_recovery_runtime.py", "tests/unit/test_routing_runtime.py", "tests/unit/test_run_agent_hook_surface.py", "tests/unit/test_run_agent_legacy_cli.py", "tests/unit/test_run_agent_status.py", "tests/unit/test_runtime_context_paths.py", "tests/unit/test_runtime_utils.py", "tests/unit/test_sdlc_shared_actions.py", "tests/unit/test_state_defaults.py", "tests/unit/test_step_completion.py", "tests/unit/test_step_runner_write_contract.py", "tests/unit/test_stop_commands.py", "tests/unit/test_submit_commands.py", "tests/unit/test_sync_workflows.py", "tests/unit/test_task_runtime.py", "tests/unit/test_tool_instruction_block.py", "tests/unit/test_transition_recovery_runtime.py", "tests/unit/test_transition_runtime.py", "tests/unit/test_workflow_bundle_validator.py", "tests/unit/test_workflow_packages.py", "tests/unit/test_workflow_registry.py", "tests/unit/test_workflow_router_notifications.py", "tests/unit/test_workflow_specs.py", "tests/unit/workflows/00_bootstrap_lifecycle_admin_v1/test_actions.py", "tests/unit/workflows/00_core_governance_bootstrap_v1/__init__.py", "tests/unit/workflows/00_core_governance_bootstrap_v1/test_core_governance_validation_action.py", "tests/unit/workflows/00_layer1_governance_bootstrap_v1/test_validation.py", "tests/unit/workflows/00_master_docs_bootstrap_v2/__init__.py", "tests/unit/workflows/00_master_docs_bootstrap_v2/test_execution_core.py", "tests/unit/workflows/00_master_docs_bootstrap_v2/test_master_docs_validation_action.py", "tests/unit/workflows/02_agent_runner_platform_v1/__init__.py", "tests/unit/workflows/02_agent_runner_platform_v1/test_platform_core_actions.py", "tests/unit/workflows/__init__.py"]
---
...
| `tests/unit/test_daemon_runtime.py` | test coverage |
| `tests/unit/test_daemon_worker_payload.py` | test coverage |
...
| `tests/unit/test_operator_console_config.py` | test coverage |
| `tests/unit/test_operator_console_services.py` | test coverage |
...
| `tests/unit/test_stop_commands.py` | test coverage |
...
| `tests/unit/workflows/00_core_governance_bootstrap_v1/__init__.py` | test coverage |
| `tests/unit/workflows/00_core_governance_bootstrap_v1/test_core_governance_validation_action.py` | test coverage |
| `tests/unit/workflows/00_layer1_governance_bootstrap_v1/test_validation.py` | test coverage |
| `tests/unit/workflows/00_master_docs_bootstrap_v2/__init__.py` | test coverage |
| `tests/unit/workflows/00_master_docs_bootstrap_v2/test_execution_core.py` | test coverage |
| `tests/unit/workflows/00_master_docs_bootstrap_v2/test_master_docs_validation_action.py` | test coverage |
...
| `tests/unit/test_daemon_runtime.py` | outbound | markdown | test coverage |
| `tests/unit/test_daemon_worker_payload.py` | outbound | markdown | test coverage |
...
| `tests/unit/test_operator_console_config.py` | outbound | markdown | test coverage |
| `tests/unit/test_operator_console_services.py` | outbound | markdown | test coverage |
...
| `tests/unit/test_stop_commands.py` | outbound | markdown | test coverage |
...
| `tests/unit/workflows/00_core_governance_bootstrap_v1/__init__.py` | outbound | markdown | test coverage |
| `tests/unit/workflows/00_core_governance_bootstrap_v1/test_core_governance_validation_action.py` | outbound | markdown | test coverage |
| `tests/unit/workflows/00_layer1_governance_bootstrap_v1/test_validation.py` | outbound | markdown | test coverage |
| `tests/unit/workflows/00_master_docs_bootstrap_v2/__init__.py` | outbound | markdown | test coverage |
| `tests/unit/workflows/00_master_docs_bootstrap_v2/test_execution_core.py` | outbound | markdown | test coverage |
| `tests/unit/workflows/00_master_docs_bootstrap_v2/test_master_docs_validation_action.py` | outbound | markdown | test coverage |
...
|------|--------|-----------------|-------------|
| 2026-07-23 | Initial baseline generated from repository scan | 72 modules/files | sdlc_00_codebase_v1 |
