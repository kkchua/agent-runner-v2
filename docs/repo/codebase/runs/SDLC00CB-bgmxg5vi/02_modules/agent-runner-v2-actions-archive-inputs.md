---
title: "Module Documentation: agent_runner_v2.actions.archive_inputs"
template_id: "CB-02"
version: "1.0.0"
doc_type: "system"
...
module_path: "agent_runner_v2/actions/archive_inputs.py"
module_area: "actions"
documentation_mode: "full"
owner_doc_path: "docs/repo/codebase/current/02_modules/agent-runner-v2-actions-archive-inputs.md"
...
# Module Documentation: agent_runner_v2.actions.archive_inputs
...
**Signature**: `archive_inputs(*, context: dict[str, str], state: dict, step_cfg: dict, project_root: Path)`

**Purpose**: Move files from source_dir to archive_dir.
