...
| `agent_runner_v2/bootstrap/workflows/default/agnes_media_gen_v1/prompts/01_extract_descriptions.txt` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/workflows/default/agnes_media_gen_v1/prompts/02_generate_prompts_v1.txt` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/workflows/default/agnes_media_gen_v1/prompts/02_generate_prompts_v2.txt` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/workflows/default/agnes_media_gen_v1/prompts/02_generate_prompts_v3.txt` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/workflows/default/agnes_media_gen_v1/prompts/02_generate_prompts_v4.txt` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/workflows/default/agnes_media_gen_v1/prompts/02_generate_prompts_v5.txt` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/workflows/default/agnes_media_gen_v1/prompts/02_generate_prompts_v6.txt` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/workflows/default/agnes_media_gen_v1/prompts/02_generate_prompts_v7.txt` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/workflows/default/agnes_media_gen_v1/prompts/02_generate_prompts_v8.txt` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/workflows/default/agnes_media_gen_v1/prompts/02_generate_prompts_v9.txt` | modify | part of repository scan baseline | medium |
...
| `agent_runner_v2/bootstrap/workflows/default/sdlc_00_codebase_v1/README.md` | modify | part of repository scan baseline | medium |
...
| `agent_runner_v2/bootstrap/workflows/default/sdlc_00_delivery_scaffold_v1/README.md` | modify | part of repository scan baseline | medium |
...
| `agent_runner_v2/bootstrap/workflows/default/sdlc_00_init_doc_v1/prompts/02b_address_critique.txt` | modify | part of repository scan baseline | medium |
...
| `agent_runner_v2/bootstrap/workflows/default/sdlc_10_requirement_v1/prompts/02b_address_critique.txt` | modify | part of repository scan baseline | medium |
...
| `agent_runner_v2/bootstrap/workflows/default/sdlc_20_planning_v1/prompts/02b_address_critique.txt` | modify | part of repository scan baseline | medium |
...
| `agent_runner_v2/bootstrap/workflows/default/sdlc_30_backlog_v1/prompts/02b_address_critique.txt` | modify | part of repository scan baseline | medium |
...
| `agent_runner_v2/bootstrap/workflows/default/sdlc_40_task_v1/prompts/02b_address_critique.txt` | modify | part of repository scan baseline | medium |
...
| `agent_runner_v2/bootstrap/workflows/default/sdlc_50_implementation_v1/prompts/02b_address_critique.txt` | modify | part of repository scan baseline | medium |
...
| `agent_runner_v2/bootstrap/workflows/default/sdlc_60_execution_v1/prompts/02b_address_critique.txt` | modify | part of repository scan baseline | medium |
...
| `agent_runner_v2/bootstrap/workflows/default/sdlc_70_validation_v1/prompts/02b_address_critique.txt` | modify | part of repository scan baseline | medium |
...
| `agent_runner_v2/bootstrap/workflows/default/sdlc_80_review_v1/prompts/02b_address_critique.txt` | modify | part of repository scan baseline | medium |
...
| `agent_runner_v2/bootstrap/workflows/default/workflow_builder_v1/actions.py` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/workflows/default/workflow_builder_v1/context_extensions.py` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/workflows/default/workflow_builder_v1/prompts/00_generate_test_criteria.txt` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/workflows/default/workflow_builder_v1/prompts/00b_review_test_criteria.txt` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/workflows/default/workflow_builder_v1/prompts/00c_refine_test_criteria.txt` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/workflows/default/workflow_builder_v1/prompts/01_analyze_spec.txt` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/workflows/default/workflow_builder_v1/prompts/01b_resolve_questions.txt` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/workflows/default/workflow_builder_v1/prompts/01c_gatekeep_requirements.txt` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/workflows/default/workflow_builder_v1/prompts/02_define_artifacts.txt` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/workflows/default/workflow_builder_v1/prompts/02b_gatekeep_artifacts.txt` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/workflows/default/workflow_builder_v1/prompts/03_design_steps.txt` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/workflows/default/workflow_builder_v1/prompts/03b_gatekeep_steps.txt` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/workflows/default/workflow_builder_v1/prompts/04_generate_package.txt` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/workflows/default/workflow_builder_v1/prompts/04b_gatekeep_package.txt` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/workflows/default/workflow_builder_v1/prompts/05_review_package.txt` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/workflows/default/workflow_builder_v1/prompts/06_refine_package.txt` | modify | part of repository scan baseline | medium |
| `agent_runner_v2/bootstrap/workflows/default/workflow_builder_v1/workflow.toml` | modify | part of repository scan baseline | medium |
...
| `docs/archive/ARCHITECTURAL_REFACTOR_FINDINGS.md` | modify | part of repository scan baseline | medium |
| `docs/archive/ARCHITECTURAL_REFACTOR_SPEC.md` | modify | part of repository scan baseline | medium |
| `docs/archive/DAEMON_RACE_CONDITIONS.md` | modify | part of repository scan baseline | medium |
...
| `docs/repo/agent_runner/sdlc/delivery/00_draft_initiatives/console-ui-mockup.html` | modify | part of repository scan baseline | medium |
...
| `docs/repo/agent_runner/sdlc/delivery/00_draft_initiatives/DRAFT-INIT-20260731-001_console-tab-separation.md` | modify | part of repository scan baseline | medium |
| `docs/repo/agent_runner/sdlc/delivery/00_draft_initiatives/DRAFT-INIT-20260731-002_console-workflow-favorites.md` | modify | part of repository scan baseline | medium |
...
| `docs/repo/agent_runner/sdlc/delivery/00_initiatives/INIT-20260723-003_console-sdlc10-support.md` | modify | part of repository scan baseline | medium |
| `docs/repo/agent_runner/sdlc/delivery/00_initiatives/INIT-20260723-004_console-sdlc10-support.md` | modify | part of repository scan baseline | medium |
| `docs/repo/agent_runner/sdlc/delivery/00_initiatives/INIT-20260723-004_console-sdlc10-support.meta.json` | modify | part of repository scan baseline | medium |
| `docs/repo/agent_runner/sdlc/delivery/00_initiatives/INIT-20260731-001_console-workflow-favorites.md` | modify | part of repository scan baseline | medium |
| `docs/repo/agent_runner/sdlc/delivery/00_initiatives/INIT-20260731-002_console-tab-separation.md` | modify | part of repository scan baseline | medium |
| `docs/repo/agent_runner/sdlc/delivery/00_initiatives/INIT-20260731-002_console-tab-separation.meta.json` | modify | part of repository scan baseline | medium |
| `docs/repo/agent_runner/sdlc/delivery/00_initiatives/INIT-20260801-001_console-tab-separation.md` | modify | part of repository scan baseline | medium |
| `docs/repo/agent_runner/sdlc/delivery/00_initiatives/INIT-20260801-002_platform-v2-architecture-redesign.md` | modify | part of repository scan baseline | medium |
...
| `docs/repo/agent_runner/sdlc/delivery/10_requirements/REQ-20260723-002_console-sdlc10-support.md` | modify | part of repository scan baseline | medium |
| `docs/repo/agent_runner/sdlc/delivery/10_requirements/REQ-20260723-003_console-sdlc10-support.md` | modify | part of repository scan baseline | medium |
...
| `docs/repo/agent_runner/sdlc/delivery/80_reviews/console-sdlc10-support-CRITIQUE-10-req.md` | modify | part of repository scan baseline | medium |
...
| `docs/repo/agent_runner/sdlc/delivery/80_reviews/console-tab-separation-CRITIQUE-00-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/agent_runner/sdlc/delivery/80_reviews/console-tab-separation-REV-00-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/agent_runner/sdlc/delivery/80_reviews/console-workflow-favorites-CRITIQUE-00-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/agent_runner/sdlc/delivery/80_reviews/console-workflow-favorites-REV-00-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/agent_runner/sdlc/delivery/80_reviews/console-workflow-favorites-REV-00-init.meta.json` | modify | part of repository scan baseline | medium |
...
| `docs/repo/codebase/history/SDLC00CB-20260723-e1c86100/codebase_manifest.json` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/01_inventory/codebase_inventory.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-action-result.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-actions-archive-inputs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-actions-copy-artifact.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-actions-documentation-validation-core.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-actions-finalize-bootstrap.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-actions-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-actions-promote-artifact.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-actions-promote-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-actions-scan-repo-codebase.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-actions-sdlc-shared-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-actions-step-completion.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-actions-sync-codebase-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-actions-sync-system-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-actions-validate-codebase-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-actions-validate-system-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-api-key-pool.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-artifact-keys.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-artifact-paths.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-backend-client.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-backend-execution.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-bootstrap-workflows-default-00-bootstrap-lifecycle-admin-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-bootstrap-workflows-default-00-bootstrap-lifecycle-admin-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-bootstrap-workflows-default-01-governance-foundation-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-bootstrap-workflows-default-01-governance-foundation-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-bootstrap-workflows-default-02-agent-runner-platform-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-bootstrap-workflows-default-02-agent-runner-platform-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-bootstrap-workflows-default-agnes-gen-video-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-bootstrap-workflows-default-agnes-gen-video-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-bootstrap-workflows-default-agnes-media-gen-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-bootstrap-workflows-default-agnes-media-gen-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-bootstrap-workflows-default-agnes-media-gen-v1-guardrails.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-codebase-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-codebase-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-delivery-scaffold-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-delivery-scaffold-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-delivery-scaffold-v1-install.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-init-doc-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-10-requirement-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-20-planning-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-30-backlog-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-40-task-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-50-implementation-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-60-execution-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-70-validation-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-80-review-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-bootstrap-workflows-default-workflow-builder-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-bootstrap-workflows-default-workflow-builder-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-bundle-governance.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-bundle-loader.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-bundle-taxonomy.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-cleanup-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-cleanup-generated-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-cli-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-codebase-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-codebase-init-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-coder-adapters.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-coder-registry.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-concurrent-api.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-config-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-config-loader.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-config-section-requirements.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-constants.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-daemon-v2.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-doc-paths.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-doc-text.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-documentation-guardrails.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-engine-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-exceptions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-execution-core.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-execution-request.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-execution-result.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-execution-support.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-failure-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-hooks-protocols.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-job-state.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-list-runs-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-manual-runtime-deps.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-manual-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-notification-manager.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-notifications.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-path-primitives.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-recovery-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-reset-step-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-routing-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-run-agent.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-runner-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-runner-logger.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-runtime-context.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-runtime-hooks.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-runtime-utils.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-shared-runtime-deps.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-show-run-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-single-instance.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-site-styles.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-state-defaults.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-status-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-step-execution-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-step-runner.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-submit-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-submitter.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-sync-workflows.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-system-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-task-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-tools-agent-tools.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-transition-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-v2-backend-client.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-v2-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-v2-queue.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-v2-sync.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-workflow-bundle-validate-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-workflow-bundle-validator.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-workflow-packages-actions-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-workflow-packages-base.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-workflow-packages-extensions-base.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-workflow-packages-hooks.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-workflow-packages-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-workflow-packages-loader.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-workflow-packages-registry.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-workflow-path-contracts.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-workflow-router.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-workflow-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-workflow-spec-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/02_modules/agent-runner-v2-workflow-specs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/03_components/actions-package.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/03_components/codebase-governance.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/03_components/config-and-data.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/03_components/scripts-suite.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/03_components/tests-suite.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/03_components/workflow-families.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/04_changes/SDLC00CB-mqe50g5d-reconcile.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/sync_logs/SDLC00CB-mqe50g5d-review.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/sync_logs/SDLC00CB-mqe50g5d-review.meta.json` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-mqe50g5d/sync_logs/SYNC-SDLC00CB-mqe50g5d.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/01_inventory/codebase_inventory.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-action-result.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-actions-archive-inputs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-actions-copy-artifact.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-actions-documentation-validation-core.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-actions-finalize-bootstrap.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-actions-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-actions-promote-artifact.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-actions-promote-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-actions-scan-repo-codebase.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-actions-sdlc-shared-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-actions-step-completion.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-actions-sync-codebase-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-actions-sync-system-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-actions-validate-codebase-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-actions-validate-system-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-api-key-pool.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-artifact-keys.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-artifact-paths.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-backend-client.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-backend-execution.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-bootstrap-workflows-default-00-bootstrap-lifecycle-admin-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-bootstrap-workflows-default-00-bootstrap-lifecycle-admin-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-bootstrap-workflows-default-01-governance-foundation-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-bootstrap-workflows-default-01-governance-foundation-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-bootstrap-workflows-default-02-agent-runner-platform-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-bootstrap-workflows-default-02-agent-runner-platform-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-bootstrap-workflows-default-agnes-gen-video-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-bootstrap-workflows-default-agnes-gen-video-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-bootstrap-workflows-default-agnes-media-gen-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-bootstrap-workflows-default-agnes-media-gen-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-bootstrap-workflows-default-agnes-media-gen-v1-guardrails.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-codebase-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-codebase-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-delivery-scaffold-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-delivery-scaffold-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-delivery-scaffold-v1-install.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-init-doc-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-10-requirement-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-20-planning-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-30-backlog-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-40-task-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-50-implementation-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-60-execution-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-70-validation-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-80-review-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-bootstrap-workflows-default-workflow-builder-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-bootstrap-workflows-default-workflow-builder-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-bundle-governance.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-bundle-loader.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-bundle-taxonomy.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-cleanup-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-cleanup-generated-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-cli-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-codebase-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-codebase-init-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-coder-adapters.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-coder-registry.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-concurrent-api.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-config-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-config-loader.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-config-section-requirements.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-constants.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-daemon-v2.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-doc-paths.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-doc-text.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-documentation-guardrails.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-engine-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-exceptions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-execution-core.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-execution-request.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-execution-result.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-execution-support.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-failure-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-hooks-protocols.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-job-state.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-list-runs-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-manual-runtime-deps.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-manual-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-notification-manager.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-notifications.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-path-primitives.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-recovery-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-reset-step-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-routing-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-run-agent.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-runner-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-runner-logger.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-runtime-context.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-runtime-hooks.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-runtime-utils.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-shared-runtime-deps.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-show-run-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-single-instance.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-site-styles.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-state-defaults.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-status-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-step-execution-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-step-runner.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-submit-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-submitter.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-sync-workflows.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-system-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-task-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-tools-agent-tools.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-transition-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-v2-backend-client.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-v2-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-v2-queue.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-v2-sync.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-workflow-bundle-validate-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-workflow-bundle-validator.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-workflow-packages-actions-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-workflow-packages-base.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-workflow-packages-extensions-base.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-workflow-packages-hooks.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-workflow-packages-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-workflow-packages-loader.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-workflow-packages-registry.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-workflow-path-contracts.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-workflow-router.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-workflow-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-workflow-spec-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/02_modules/agent-runner-v2-workflow-specs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/03_components/actions-package.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/03_components/codebase-governance.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/03_components/config-and-data.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/03_components/scripts-suite.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/03_components/tests-suite.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/03_components/workflow-families.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/04_changes/SDLC00CB-roo6dyno-reconcile.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/sync_logs/SDLC00CB-roo6dyno-review.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/sync_logs/SDLC00CB-roo6dyno-review.meta.json` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/sync_logs/SDLC00CB-roo6dyno-review_iter2.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-roo6dyno/sync_logs/SYNC-SDLC00CB-roo6dyno.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/01_inventory/codebase_inventory.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/01_inventory/codebase_inventory.meta.json` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-action-result.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-actions-archive-inputs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-actions-copy-artifact.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-actions-documentation-validation-core.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-actions-finalize-bootstrap.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-actions-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-actions-promote-artifact.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-actions-promote-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-actions-scan-repo-codebase.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-actions-sdlc-shared-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-actions-step-completion.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-actions-sync-codebase-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-actions-sync-system-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-actions-validate-codebase-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-actions-validate-system-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-api-key-pool.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-artifact-keys.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-artifact-paths.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-backend-client.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-backend-execution.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-bootstrap-workflows-default-00-bootstrap-lifecycle-admin-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-bootstrap-workflows-default-00-bootstrap-lifecycle-admin-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-bootstrap-workflows-default-01-governance-foundation-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-bootstrap-workflows-default-01-governance-foundation-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-bootstrap-workflows-default-02-agent-runner-platform-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-bootstrap-workflows-default-02-agent-runner-platform-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-bootstrap-workflows-default-agnes-gen-video-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-bootstrap-workflows-default-agnes-gen-video-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-bootstrap-workflows-default-agnes-media-gen-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-bootstrap-workflows-default-agnes-media-gen-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-bootstrap-workflows-default-agnes-media-gen-v1-guardrails.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-codebase-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-codebase-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-delivery-scaffold-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-delivery-scaffold-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-delivery-scaffold-v1-install.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-init-doc-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-10-requirement-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-20-planning-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-30-backlog-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-40-task-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-50-implementation-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-60-execution-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-70-validation-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-80-review-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-bootstrap-workflows-default-workflow-builder-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-bootstrap-workflows-default-workflow-builder-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-bundle-governance.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-bundle-loader.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-bundle-taxonomy.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-cleanup-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-cleanup-generated-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-cli-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-codebase-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-codebase-init-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-coder-adapters.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-coder-registry.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-concurrent-api.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-config-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-config-loader.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-config-section-requirements.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-constants.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-daemon-v2.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-doc-paths.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-doc-text.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-documentation-guardrails.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-engine-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-exceptions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-execution-core.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-execution-request.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-execution-result.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-execution-support.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-failure-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-hooks-protocols.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-job-state.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-list-runs-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-manual-runtime-deps.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-manual-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-notification-manager.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-notifications.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-path-primitives.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-recovery-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-reset-step-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-routing-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-run-agent.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-runner-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-runner-logger.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-runtime-context.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-runtime-hooks.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-runtime-utils.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-shared-runtime-deps.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-show-run-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-single-instance.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-site-styles.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-state-defaults.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-status-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-step-execution-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-step-runner.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-submit-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-submitter.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-sync-workflows.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-system-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-task-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-tools-agent-tools.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-transition-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-v2-backend-client.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-v2-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-v2-queue.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-v2-sync.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-workflow-bundle-validate-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-workflow-bundle-validator.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-workflow-packages-actions-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-workflow-packages-base.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-workflow-packages-extensions-base.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-workflow-packages-hooks.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-workflow-packages-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-workflow-packages-loader.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-workflow-packages-registry.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-workflow-path-contracts.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-workflow-router.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-workflow-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-workflow-spec-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/02_modules/agent-runner-v2-workflow-specs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/03_components/actions-package.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/03_components/codebase-governance.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/03_components/config-and-data.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/03_components/scripts-suite.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/03_components/tests-suite.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/03_components/workflow-families.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/04_changes/SDLC00CB-zcezjfyu-reconcile.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/sync_logs/SDLC00CB-zcezjfyu-review.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/sync_logs/SDLC00CB-zcezjfyu-review.meta.json` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-zcezjfyu/sync_logs/SYNC-SDLC00CB-zcezjfyu.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/01_inventory/codebase_inventory.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/01_inventory/codebase_inventory.meta.json` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-action-result.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-actions-archive-inputs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-actions-copy-artifact.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-actions-documentation-validation-core.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-actions-finalize-bootstrap.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-actions-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-actions-promote-artifact.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-actions-promote-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-actions-scan-repo-codebase.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-actions-sdlc-shared-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-actions-step-completion.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-actions-sync-codebase-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-actions-sync-system-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-actions-validate-codebase-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-actions-validate-system-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-api-key-pool.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-artifact-keys.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-artifact-paths.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-backend-client.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-backend-execution.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-bootstrap-workflows-default-00-bootstrap-lifecycle-admin-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-bootstrap-workflows-default-00-bootstrap-lifecycle-admin-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-bootstrap-workflows-default-01-governance-foundation-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-bootstrap-workflows-default-01-governance-foundation-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-bootstrap-workflows-default-02-agent-runner-platform-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-bootstrap-workflows-default-02-agent-runner-platform-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-bootstrap-workflows-default-agnes-gen-video-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-bootstrap-workflows-default-agnes-gen-video-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-bootstrap-workflows-default-agnes-media-gen-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-bootstrap-workflows-default-agnes-media-gen-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-bootstrap-workflows-default-agnes-media-gen-v1-guardrails.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-codebase-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-codebase-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-delivery-scaffold-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-delivery-scaffold-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-delivery-scaffold-v1-install.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-init-doc-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-10-requirement-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-20-planning-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-30-backlog-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-40-task-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-50-implementation-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-60-execution-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-70-validation-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-80-review-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-bootstrap-workflows-default-workflow-builder-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-bootstrap-workflows-default-workflow-builder-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-bundle-governance.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-bundle-loader.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-bundle-taxonomy.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-cleanup-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-cleanup-generated-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-cli-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-codebase-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-codebase-init-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-coder-adapters.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-coder-registry.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-concurrent-api.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-config-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-config-loader.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-config-section-requirements.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-constants.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-daemon-v2.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-doc-paths.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-doc-text.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-documentation-guardrails.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-engine-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-exceptions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-execution-core.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-execution-request.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-execution-result.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-execution-support.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-failure-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-hooks-protocols.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-job-state.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-list-runs-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-manual-runtime-deps.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-manual-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-notification-manager.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-notifications.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-path-primitives.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-recovery-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-reset-step-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-routing-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-run-agent.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-runner-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-runner-logger.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-runtime-context.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-runtime-hooks.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-runtime-utils.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-shared-runtime-deps.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-show-run-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-single-instance.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-site-styles.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-state-defaults.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-status-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-step-execution-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-step-runner.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-submit-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-submitter.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-sync-workflows.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-system-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-task-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-tools-agent-tools.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-transition-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-v2-backend-client.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-v2-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-v2-queue.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-v2-sync.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-workflow-bundle-validate-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-workflow-bundle-validator.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-workflow-packages-actions-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-workflow-packages-base.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-workflow-packages-extensions-base.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-workflow-packages-hooks.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-workflow-packages-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-workflow-packages-loader.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-workflow-packages-registry.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-workflow-path-contracts.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-workflow-router.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-workflow-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-workflow-spec-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/02_modules/agent-runner-v2-workflow-specs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/03_components/actions-package.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/03_components/codebase-governance.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/03_components/config-and-data.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/03_components/scripts-suite.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/03_components/tests-suite.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/03_components/workflow-families.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/04_changes/SDLC00CB-ztsaenv1-reconcile.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/sync_logs/SDLC00CB-ztsaenv1-review.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/sync_logs/SDLC00CB-ztsaenv1-review.meta.json` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-ztsaenv1/sync_logs/SYNC-SDLC00CB-ztsaenv1.md` | modify | part of repository scan baseline | medium |
...
| `docs/repo/workflow_builder/runs/WFBUILD-20260725-0bb6afa4/ARTIFACTS-20260725-001_media_gen_v1.md` | modify | part of repository scan baseline | medium |
| `docs/repo/workflow_builder/runs/WFBUILD-20260725-0bb6afa4/PROMPTS-20260725-001_media_gen_v1.md` | modify | part of repository scan baseline | medium |
| `docs/repo/workflow_builder/runs/WFBUILD-20260725-0bb6afa4/README.md` | modify | part of repository scan baseline | medium |
| `docs/repo/workflow_builder/runs/WFBUILD-20260725-0bb6afa4/REQUIREMENTS-20260725-001_media_gen_v1.md` | modify | part of repository scan baseline | medium |
| `docs/repo/workflow_builder/runs/WFBUILD-20260725-0bb6afa4/REVIEW-20260725-001_media_gen_v1.md` | modify | part of repository scan baseline | medium |
| `docs/repo/workflow_builder/runs/WFBUILD-20260725-0bb6afa4/STEPS-20260725-001_media_gen_v1.md` | modify | part of repository scan baseline | medium |
| `docs/repo/workflow_builder/runs/WFBUILD-20260725-0bb6afa4/validation-report-WFBUILD-20260725-0bb6afa4.md` | modify | part of repository scan baseline | medium |
| `docs/repo/workflow_builder/runs/WFBUILD-20260725-0bb6afa4/workflow.toml` | modify | part of repository scan baseline | medium |
| `docs/repo/workflow_builder/runs/WFBUILD-20260725-61c44baa/ARTIFACTS-20260726-001_media_gen_v1.md` | modify | part of repository scan baseline | medium |
| `docs/repo/workflow_builder/runs/WFBUILD-20260725-61c44baa/PROMPTS-20260726-001_media_gen_v1.md` | modify | part of repository scan baseline | medium |
| `docs/repo/workflow_builder/runs/WFBUILD-20260725-61c44baa/README.md` | modify | part of repository scan baseline | medium |
| `docs/repo/workflow_builder/runs/WFBUILD-20260725-61c44baa/REQUIREMENTS-20260726-001_media_gen_v1.md` | modify | part of repository scan baseline | medium |
| `docs/repo/workflow_builder/runs/WFBUILD-20260725-61c44baa/REVIEW-20260726-001_agnes_media_gen_v1.md` | modify | part of repository scan baseline | medium |
| `docs/repo/workflow_builder/runs/WFBUILD-20260725-61c44baa/REVIEW-20260726-001_media_gen_v1.md` | modify | part of repository scan baseline | medium |
| `docs/repo/workflow_builder/runs/WFBUILD-20260725-61c44baa/STEPS-20260726-001_media_gen_v1.md` | modify | part of repository scan baseline | medium |
| `docs/repo/workflow_builder/runs/WFBUILD-20260725-61c44baa/TEST_CRITERIA-20260726-001_media_gen_v1.md` | modify | part of repository scan baseline | medium |
| `docs/repo/workflow_builder/runs/WFBUILD-20260725-61c44baa/validation-report-WFBUILD-20260725-61c44baa.md` | modify | part of repository scan baseline | medium |
| `docs/repo/workflow_builder/runs/WFBUILD-20260725-61c44baa/workflow.toml` | modify | part of repository scan baseline | medium |
| `docs/repo/workflow_builder/runs/WFBUILD-20260728-16472873/TEST_CRITERIA-20260728-001_master_generator_v1.md` | modify | part of repository scan baseline | medium |
| `docs/repo/workflow_builder/runs/WFBUILD-20260728-718d968c/ARTIFACTS-20260728-001_master_gen_v1.md` | modify | part of repository scan baseline | medium |
| `docs/repo/workflow_builder/runs/WFBUILD-20260728-718d968c/PROMPTS-20260728-001_master_gen_v1.md` | modify | part of repository scan baseline | medium |
| `docs/repo/workflow_builder/runs/WFBUILD-20260728-718d968c/README.md` | modify | part of repository scan baseline | medium |
| `docs/repo/workflow_builder/runs/WFBUILD-20260728-718d968c/REQUIREMENTS-20260728-001_master_gen_v1.md` | modify | part of repository scan baseline | medium |
| `docs/repo/workflow_builder/runs/WFBUILD-20260728-718d968c/REVIEW-20260728-001_master_gen_v1.md` | modify | part of repository scan baseline | medium |
| `docs/repo/workflow_builder/runs/WFBUILD-20260728-718d968c/STEPS-20260728-001_master_gen_v1.md` | modify | part of repository scan baseline | medium |
| `docs/repo/workflow_builder/runs/WFBUILD-20260728-718d968c/TEST_CRITERIA-20260728-001_master_gen_v1.md` | modify | part of repository scan baseline | medium |
| `docs/repo/workflow_builder/runs/WFBUILD-20260728-718d968c/workflow.toml` | modify | part of repository scan baseline | medium |
| `docs/repo/workflow_builder/runs/WFBUILD-20260728-bed6a2e9/GATEKEEP-REQ-20260729-001_master_gen_v2.md` | modify | part of repository scan baseline | medium |
| `docs/repo/workflow_builder/runs/WFBUILD-20260728-bed6a2e9/REQUIREMENTS-20260729-001_master_gen_v2.md` | modify | part of repository scan baseline | medium |
| `docs/repo/workflow_builder/runs/WFBUILD-20260728-bed6a2e9/REVIEW-20260729-001_master_gen_v2.md` | modify | part of repository scan baseline | medium |
| `docs/repo/workflow_builder/runs/WFBUILD-20260728-bed6a2e9/TEST_CRITERIA-20260729-001_master_gen_v2.md` | modify | part of repository scan baseline | medium |
| `docs/repo/workflow_builder/specs/agnes_media_gen_v1.md` | modify | part of repository scan baseline | medium |
...
| `docs/system/00_governance/bootstrap/workflows/agnes_gen_video_v1/README.md` | modify | part of repository scan baseline | medium |
| `docs/system/00_governance/bootstrap/workflows/agnes_gen_video_v1/workflow.toml` | modify | part of repository scan baseline | medium |
| `docs/system/00_governance/bootstrap/workflows/agnes_media_gen_v1/README.md` | modify | part of repository scan baseline | medium |
| `docs/system/00_governance/bootstrap/workflows/agnes_media_gen_v1/workflow.toml` | modify | part of repository scan baseline | medium |
...
| `docs/system/00_governance/bootstrap/workflows/sdlc_00_codebase_v1/README.md` | modify | part of repository scan baseline | medium |
...
| `docs/system/00_governance/bootstrap/workflows/sdlc_00_delivery_scaffold_v1/README.md` | modify | part of repository scan baseline | medium |
...
| `docs/system/00_governance/bootstrap/workflows/sdlc_00_init_doc_v1/DRAFT_INIT_AUTHORING_GUIDE.md` | modify | part of repository scan baseline | medium |
| `docs/system/00_governance/bootstrap/workflows/sdlc_00_init_doc_v1/README.md` | modify | part of repository scan baseline | medium |
...
| `docs/system/00_governance/bootstrap/workflows/sdlc_10_requirement_v1/README.md` | modify | part of repository scan baseline | medium |
...
| `docs/system/00_governance/bootstrap/workflows/sdlc_20_planning_v1/README.md` | modify | part of repository scan baseline | medium |
...
| `docs/system/00_governance/bootstrap/workflows/sdlc_30_backlog_v1/README.md` | modify | part of repository scan baseline | medium |
...
| `docs/system/00_governance/bootstrap/workflows/sdlc_40_task_v1/README.md` | modify | part of repository scan baseline | medium |
...
| `docs/system/00_governance/bootstrap/workflows/sdlc_50_implementation_v1/README.md` | modify | part of repository scan baseline | medium |
...
| `docs/system/00_governance/bootstrap/workflows/sdlc_60_execution_v1/README.md` | modify | part of repository scan baseline | medium |
...
| `docs/system/00_governance/bootstrap/workflows/sdlc_70_validation_v1/README.md` | modify | part of repository scan baseline | medium |
...
| `docs/system/00_governance/bootstrap/workflows/sdlc_80_review_v1/README.md` | modify | part of repository scan baseline | medium |
...
| `docs/system/00_governance/bootstrap/workflows/workflow_builder_v1/workflow.toml` | modify | part of repository scan baseline | medium |
...
| `workflows/sdlc_00_codebase_v1/README.md` | modify | part of repository scan baseline | medium |
| `workflows/sdlc_00_codebase_v1/workflow.toml` | modify | part of repository scan baseline | medium |
| `workflows/sdlc_00_delivery_scaffold_v1/README.md` | modify | part of repository scan baseline | medium |
...
| `workflows/workflow_builder_v1/workflow.toml` | modify | part of repository scan baseline | medium |
...
|----------|------|------|--------|
| `codebase_inventory.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/01_inventory/codebase_inventory.md` | module/component/inventory | draft |
| `agent-runner-v2-init.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-init.md` | module/component/inventory | draft |
| `agent-runner-v2-action-result.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-action-result.md` | module/component/inventory | draft |
| `agent-runner-v2-actions-init.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-actions-init.md` | module/component/inventory | draft |
| `agent-runner-v2-actions-archive-inputs.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-actions-archive-inputs.md` | module/component/inventory | draft |
| `agent-runner-v2-actions-copy-artifact.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-actions-copy-artifact.md` | module/component/inventory | draft |
| `agent-runner-v2-actions-documentation-validation-core.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-actions-documentation-validation-core.md` | module/component/inventory | draft |
| `agent-runner-v2-actions-finalize-bootstrap.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-actions-finalize-bootstrap.md` | module/component/inventory | draft |
| `agent-runner-v2-actions-promote-artifact.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-actions-promote-artifact.md` | module/component/inventory | draft |
| `agent-runner-v2-actions-promote-init.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-actions-promote-init.md` | module/component/inventory | draft |
| `agent-runner-v2-actions-scan-repo-codebase.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-actions-scan-repo-codebase.md` | module/component/inventory | draft |
| `agent-runner-v2-actions-sdlc-shared-actions.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-actions-sdlc-shared-actions.md` | module/component/inventory | draft |
| `agent-runner-v2-actions-step-completion.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-actions-step-completion.md` | module/component/inventory | draft |
| `agent-runner-v2-actions-sync-codebase-docs.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-actions-sync-codebase-docs.md` | module/component/inventory | draft |
| `agent-runner-v2-actions-sync-system-docs.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-actions-sync-system-docs.md` | module/component/inventory | draft |
| `agent-runner-v2-actions-validate-codebase-docs.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-actions-validate-codebase-docs.md` | module/component/inventory | draft |
| `agent-runner-v2-actions-validate-system-docs.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-actions-validate-system-docs.md` | module/component/inventory | draft |
| `agent-runner-v2-api-key-pool.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-api-key-pool.md` | module/component/inventory | draft |
| `agent-runner-v2-artifact-keys.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-artifact-keys.md` | module/component/inventory | draft |
| `agent-runner-v2-artifact-paths.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-artifact-paths.md` | module/component/inventory | draft |
| `agent-runner-v2-backend-client.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-backend-client.md` | module/component/inventory | draft |
| `agent-runner-v2-backend-execution.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-backend-execution.md` | module/component/inventory | draft |
| `agent-runner-v2-bootstrap-workflows-default-00-bootstrap-lifecycle-admin-v1-actions.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-bootstrap-workflows-default-00-bootstrap-lifecycle-admin-v1-actions.md` | module/component/inventory | draft |
| `agent-runner-v2-bootstrap-workflows-default-00-bootstrap-lifecycle-admin-v1-context-extensions.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-bootstrap-workflows-default-00-bootstrap-lifecycle-admin-v1-context-extensions.md` | module/component/inventory | draft |
| `agent-runner-v2-bootstrap-workflows-default-01-governance-foundation-v1-actions.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-bootstrap-workflows-default-01-governance-foundation-v1-actions.md` | module/component/inventory | draft |
| `agent-runner-v2-bootstrap-workflows-default-01-governance-foundation-v1-context-extensions.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-bootstrap-workflows-default-01-governance-foundation-v1-context-extensions.md` | module/component/inventory | draft |
| `agent-runner-v2-bootstrap-workflows-default-02-agent-runner-platform-v1-actions.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-bootstrap-workflows-default-02-agent-runner-platform-v1-actions.md` | module/component/inventory | draft |
| `agent-runner-v2-bootstrap-workflows-default-02-agent-runner-platform-v1-context-extensions.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-bootstrap-workflows-default-02-agent-runner-platform-v1-context-extensions.md` | module/component/inventory | draft |
| `agent-runner-v2-bootstrap-workflows-default-agnes-gen-video-v1-actions.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-bootstrap-workflows-default-agnes-gen-video-v1-actions.md` | module/component/inventory | draft |
| `agent-runner-v2-bootstrap-workflows-default-agnes-gen-video-v1-context-extensions.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-bootstrap-workflows-default-agnes-gen-video-v1-context-extensions.md` | module/component/inventory | draft |
| `agent-runner-v2-bootstrap-workflows-default-agnes-media-gen-v1-actions.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-bootstrap-workflows-default-agnes-media-gen-v1-actions.md` | module/component/inventory | draft |
| `agent-runner-v2-bootstrap-workflows-default-agnes-media-gen-v1-context-extensions.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-bootstrap-workflows-default-agnes-media-gen-v1-context-extensions.md` | module/component/inventory | draft |
| `agent-runner-v2-bootstrap-workflows-default-agnes-media-gen-v1-guardrails.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-bootstrap-workflows-default-agnes-media-gen-v1-guardrails.md` | module/component/inventory | draft |
| `agent-runner-v2-bootstrap-workflows-default-sdlc-00-codebase-v1-actions.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-codebase-v1-actions.md` | module/component/inventory | draft |
| `agent-runner-v2-bootstrap-workflows-default-sdlc-00-codebase-v1-context-extensions.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-codebase-v1-context-extensions.md` | module/component/inventory | draft |
| `agent-runner-v2-bootstrap-workflows-default-sdlc-00-delivery-scaffold-v1-actions.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-delivery-scaffold-v1-actions.md` | module/component/inventory | draft |
| `agent-runner-v2-bootstrap-workflows-default-sdlc-00-delivery-scaffold-v1-context-extensions.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-delivery-scaffold-v1-context-extensions.md` | module/component/inventory | draft |
| `agent-runner-v2-bootstrap-workflows-default-sdlc-00-delivery-scaffold-v1-install.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-delivery-scaffold-v1-install.md` | module/component/inventory | draft |
| `agent-runner-v2-bootstrap-workflows-default-sdlc-00-init-doc-v1-context-extensions.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-init-doc-v1-context-extensions.md` | module/component/inventory | draft |
| `agent-runner-v2-bootstrap-workflows-default-sdlc-10-requirement-v1-context-extensions.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-10-requirement-v1-context-extensions.md` | module/component/inventory | draft |
| `agent-runner-v2-bootstrap-workflows-default-sdlc-20-planning-v1-context-extensions.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-20-planning-v1-context-extensions.md` | module/component/inventory | draft |
| `agent-runner-v2-bootstrap-workflows-default-sdlc-30-backlog-v1-context-extensions.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-30-backlog-v1-context-extensions.md` | module/component/inventory | draft |
| `agent-runner-v2-bootstrap-workflows-default-sdlc-40-task-v1-context-extensions.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-40-task-v1-context-extensions.md` | module/component/inventory | draft |
| `agent-runner-v2-bootstrap-workflows-default-sdlc-50-implementation-v1-context-extensions.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-50-implementation-v1-context-extensions.md` | module/component/inventory | draft |
| `agent-runner-v2-bootstrap-workflows-default-sdlc-60-execution-v1-context-extensions.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-60-execution-v1-context-extensions.md` | module/component/inventory | draft |
| `agent-runner-v2-bootstrap-workflows-default-sdlc-70-validation-v1-context-extensions.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-70-validation-v1-context-extensions.md` | module/component/inventory | draft |
| `agent-runner-v2-bootstrap-workflows-default-sdlc-80-review-v1-context-extensions.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-80-review-v1-context-extensions.md` | module/component/inventory | draft |
| `agent-runner-v2-bootstrap-workflows-default-workflow-builder-v1-actions.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-bootstrap-workflows-default-workflow-builder-v1-actions.md` | module/component/inventory | draft |
| `agent-runner-v2-bootstrap-workflows-default-workflow-builder-v1-context-extensions.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-bootstrap-workflows-default-workflow-builder-v1-context-extensions.md` | module/component/inventory | draft |
| `agent-runner-v2-bundle-governance.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-bundle-governance.md` | module/component/inventory | draft |
| `agent-runner-v2-bundle-loader.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-bundle-loader.md` | module/component/inventory | draft |
| `agent-runner-v2-bundle-taxonomy.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-bundle-taxonomy.md` | module/component/inventory | draft |
| `agent-runner-v2-cleanup-commands.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-cleanup-commands.md` | module/component/inventory | draft |
| `agent-runner-v2-cleanup-generated-docs.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-cleanup-generated-docs.md` | module/component/inventory | draft |
| `agent-runner-v2-cli-runtime.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-cli-runtime.md` | module/component/inventory | draft |
| `agent-runner-v2-codebase-docs.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-codebase-docs.md` | module/component/inventory | draft |
| `agent-runner-v2-codebase-init-commands.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-codebase-init-commands.md` | module/component/inventory | draft |
| `agent-runner-v2-coder-adapters.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-coder-adapters.md` | module/component/inventory | draft |
| `agent-runner-v2-coder-registry.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-coder-registry.md` | module/component/inventory | draft |
| `agent-runner-v2-concurrent-api.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-concurrent-api.md` | module/component/inventory | draft |
| `agent-runner-v2-config-init.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-config-init.md` | module/component/inventory | draft |
| `agent-runner-v2-config-section-requirements.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-config-section-requirements.md` | module/component/inventory | draft |
| `agent-runner-v2-config-loader.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-config-loader.md` | module/component/inventory | draft |
| `agent-runner-v2-constants.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-constants.md` | module/component/inventory | draft |
| `agent-runner-v2-daemon-v2.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-daemon-v2.md` | module/component/inventory | draft |
| `agent-runner-v2-doc-paths.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-doc-paths.md` | module/component/inventory | draft |
| `agent-runner-v2-doc-text.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-doc-text.md` | module/component/inventory | draft |
| `agent-runner-v2-documentation-guardrails.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-documentation-guardrails.md` | module/component/inventory | draft |
| `agent-runner-v2-engine-commands.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-engine-commands.md` | module/component/inventory | draft |
| `agent-runner-v2-exceptions.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-exceptions.md` | module/component/inventory | draft |
| `agent-runner-v2-execution-core.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-execution-core.md` | module/component/inventory | draft |
| `agent-runner-v2-execution-request.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-execution-request.md` | module/component/inventory | draft |
| `agent-runner-v2-execution-result.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-execution-result.md` | module/component/inventory | draft |
| `agent-runner-v2-execution-support.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-execution-support.md` | module/component/inventory | draft |
| `agent-runner-v2-failure-runtime.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-failure-runtime.md` | module/component/inventory | draft |
| `agent-runner-v2-hooks-protocols.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-hooks-protocols.md` | module/component/inventory | draft |
| `agent-runner-v2-job-state.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-job-state.md` | module/component/inventory | draft |
| `agent-runner-v2-list-runs-commands.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-list-runs-commands.md` | module/component/inventory | draft |
| `agent-runner-v2-manual-runtime.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-manual-runtime.md` | module/component/inventory | draft |
| `agent-runner-v2-manual-runtime-deps.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-manual-runtime-deps.md` | module/component/inventory | draft |
| `agent-runner-v2-notification-manager.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-notification-manager.md` | module/component/inventory | draft |
| `agent-runner-v2-notifications.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-notifications.md` | module/component/inventory | draft |
| `agent-runner-v2-path-primitives.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-path-primitives.md` | module/component/inventory | draft |
| `agent-runner-v2-recovery-runtime.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-recovery-runtime.md` | module/component/inventory | draft |
| `agent-runner-v2-reset-step-commands.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-reset-step-commands.md` | module/component/inventory | draft |
| `agent-runner-v2-routing-runtime.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-routing-runtime.md` | module/component/inventory | draft |
| `agent-runner-v2-run-agent.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-run-agent.md` | module/component/inventory | draft |
| `agent-runner-v2-runner-actions.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-runner-actions.md` | module/component/inventory | draft |
| `agent-runner-v2-runner-logger.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-runner-logger.md` | module/component/inventory | draft |
| `agent-runner-v2-runtime-context.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-runtime-context.md` | module/component/inventory | draft |
| `agent-runner-v2-runtime-hooks.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-runtime-hooks.md` | module/component/inventory | draft |
| `agent-runner-v2-runtime-utils.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-runtime-utils.md` | module/component/inventory | draft |
| `agent-runner-v2-shared-runtime-deps.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-shared-runtime-deps.md` | module/component/inventory | draft |
| `agent-runner-v2-show-run-commands.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-show-run-commands.md` | module/component/inventory | draft |
| `agent-runner-v2-single-instance.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-single-instance.md` | module/component/inventory | draft |
| `agent-runner-v2-site-styles.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-site-styles.md` | module/component/inventory | draft |
| `agent-runner-v2-state-defaults.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-state-defaults.md` | module/component/inventory | draft |
| `agent-runner-v2-status-commands.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-status-commands.md` | module/component/inventory | draft |
| `agent-runner-v2-step-execution-runtime.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-step-execution-runtime.md` | module/component/inventory | draft |
| `agent-runner-v2-step-runner.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-step-runner.md` | module/component/inventory | draft |
| `agent-runner-v2-submit-commands.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-submit-commands.md` | module/component/inventory | draft |
| `agent-runner-v2-submitter.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-submitter.md` | module/component/inventory | draft |
| `agent-runner-v2-sync-workflows.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-sync-workflows.md` | module/component/inventory | draft |
| `agent-runner-v2-system-docs.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-system-docs.md` | module/component/inventory | draft |
| `agent-runner-v2-task-runtime.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-task-runtime.md` | module/component/inventory | draft |
| `agent-runner-v2-tools-agent-tools.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-tools-agent-tools.md` | module/component/inventory | draft |
| `agent-runner-v2-transition-runtime.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-transition-runtime.md` | module/component/inventory | draft |
| `agent-runner-v2-v2-init.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-v2-init.md` | module/component/inventory | draft |
| `agent-runner-v2-v2-backend-client.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-v2-backend-client.md` | module/component/inventory | draft |
| `agent-runner-v2-v2-queue.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-v2-queue.md` | module/component/inventory | draft |
| `agent-runner-v2-v2-sync.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-v2-sync.md` | module/component/inventory | draft |
| `agent-runner-v2-workflow-bundle-validate-commands.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-workflow-bundle-validate-commands.md` | module/component/inventory | draft |
| `agent-runner-v2-workflow-bundle-validator.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-workflow-bundle-validator.md` | module/component/inventory | draft |
| `agent-runner-v2-workflow-packages-init.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-workflow-packages-init.md` | module/component/inventory | draft |
| `agent-runner-v2-workflow-packages-actions-init.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-workflow-packages-actions-init.md` | module/component/inventory | draft |
| `agent-runner-v2-workflow-packages-base.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-workflow-packages-base.md` | module/component/inventory | draft |
| `agent-runner-v2-workflow-packages-extensions-base.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-workflow-packages-extensions-base.md` | module/component/inventory | draft |
| `agent-runner-v2-workflow-packages-hooks.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-workflow-packages-hooks.md` | module/component/inventory | draft |
| `agent-runner-v2-workflow-packages-loader.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-workflow-packages-loader.md` | module/component/inventory | draft |
| `agent-runner-v2-workflow-packages-registry.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-workflow-packages-registry.md` | module/component/inventory | draft |
| `agent-runner-v2-workflow-path-contracts.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-workflow-path-contracts.md` | module/component/inventory | draft |
| `agent-runner-v2-workflow-router.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-workflow-router.md` | module/component/inventory | draft |
| `agent-runner-v2-workflow-runtime.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-workflow-runtime.md` | module/component/inventory | draft |
| `agent-runner-v2-workflow-spec-commands.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-workflow-spec-commands.md` | module/component/inventory | draft |
| `agent-runner-v2-workflow-specs.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-workflow-specs.md` | module/component/inventory | draft |
| `workflow-families.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/03_components/workflow-families.md` | module/component/inventory | draft |
| `actions-package.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/03_components/actions-package.md` | module/component/inventory | draft |
| `tests-suite.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/03_components/tests-suite.md` | module/component/inventory | draft |
| `scripts-suite.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/03_components/scripts-suite.md` | module/component/inventory | draft |
| `config-and-data.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/03_components/config-and-data.md` | module/component/inventory | draft |
| `codebase-governance.md` | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/03_components/codebase-governance.md` | module/component/inventory | draft |
...
|--------|----------------|------------|----------------|
| `codebase_inventory.md` | undocumented | current | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/01_inventory/codebase_inventory.md` |
| `agent-runner-v2-init.md` | undocumented | current | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-init.md` |
| `agent-runner-v2-action-result.md` | undocumented | current | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-action-result.md` |
| `agent-runner-v2-actions-init.md` | undocumented | current | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-actions-init.md` |
| `agent-runner-v2-actions-archive-inputs.md` | undocumented | current | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-actions-archive-inputs.md` |
| `agent-runner-v2-actions-copy-artifact.md` | undocumented | current | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-actions-copy-artifact.md` |
| `agent-runner-v2-actions-documentation-validation-core.md` | undocumented | current | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-actions-documentation-validation-core.md` |
| `agent-runner-v2-actions-finalize-bootstrap.md` | undocumented | current | `docs/repo/codebase/runs/SDLC00CB-bgmxg5vi/02_modules/agent-runner-v2-actions-finalize-bootstrap.md` |
