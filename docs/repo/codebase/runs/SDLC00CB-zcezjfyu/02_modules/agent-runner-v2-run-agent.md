...
| `importlib.metadata` | stdlib module | imported dependency |
...
**Purpose**: Parse CLI arguments for all runner commands.

**Parameters**:

| Name | Type | Default | Description |
|------|------|---------|-------------|
| `argv` | `list[str] | None` | `None` | Optional argument list. Defaults to sys.argv[1:]. |
