...
owner_doc_path: "docs/repo/codebase/current/02_modules/agent-runner-v2-actions-scan-repo-codebase.md"
...
**Signature**: `scan_repo_codebase(*, context: dict[str, str], state: dict, step_cfg: dict, project_root: Path)`
