...
**Signature**: `install_all(*, workspace_root: Path, runner_home: Path)`

**Purpose**: Call ``install_to_global()`` on all workflows.
...
**Signature**: `sync_all(*, workspace_root: Path)`

**Purpose**: Call ``sync_to_backend()`` on all workflows.
