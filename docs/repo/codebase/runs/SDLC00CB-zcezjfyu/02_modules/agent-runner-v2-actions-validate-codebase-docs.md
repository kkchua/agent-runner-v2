...
owner_doc_path: "docs/repo/codebase/current/02_modules/agent-runner-v2-actions-validate-codebase-docs.md"
...
**Signature**: `validate_codebase_docs(*, context: dict[str, str], state: dict, step_cfg: dict, project_root: Path)`
