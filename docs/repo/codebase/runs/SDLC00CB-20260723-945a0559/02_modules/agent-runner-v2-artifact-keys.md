---
title: "Module Documentation: agent_runner_v2.artifact_keys"
template_id: "CB-02"
version: "1.0.0"
doc_type: "system"
...
module_path: "agent_runner_v2/artifact_keys.py"
module_area: "support"
documentation_mode: "summary"
owner_doc_path: "docs/repo/codebase/current/02_modules/agent-runner-v2-artifact-keys.md"
...
# Module Documentation: agent_runner_v2.artifact_keys
...
| `ARTIFACT_KEY_REQ` | module configuration |
| `ARTIFACT_KEY_BACKLOG` | module configuration |
| `ARTIFACT_KEY_EXEC` | module configuration |
| `ARTIFACT_KEY_VAL` | module configuration |
| `ARTIFACT_KEY_REV` | module configuration |
| `ARTIFACT_KEY_MEM` | module configuration |
| `ARTIFACT_KEY_CLOSE` | module configuration |
| `ARTIFACT_KEY_SDLC_TEMPLATE_REGISTRY` | module configuration |
| `ARTIFACT_KEY_SDLC_WORKFLOW_SOP` | module configuration |
| `ARTIFACT_KEY_SDLC_TEMPLATE_DRAFT_INIT` | module configuration |
| `ARTIFACT_KEY_SDLC_TEMPLATE_INIT` | module configuration |
| `ARTIFACT_KEY_SDLC_TEMPLATE_REQ` | module configuration |
| `ARTIFACT_KEY_SDLC_TEMPLATE_PLAN` | module configuration |
| `ARTIFACT_KEY_SDLC_TEMPLATE_BACKLOG` | module configuration |
| `ARTIFACT_KEY_SDLC_TEMPLATE_TASK` | module configuration |
| `ARTIFACT_KEY_SDLC_TEMPLATE_IMPL` | module configuration |
| `ARTIFACT_KEY_SDLC_TEMPLATE_VALID` | module configuration |
| `ARTIFACT_KEY_SDLC_TEMPLATE_REV` | module configuration |
| `ARTIFACT_KEY_SDLC_TEMPLATE_MEM` | module configuration |
| `ARTIFACT_KEY_SDLC_TEMPLATE_CLOSE` | module configuration |
| `ARTIFACT_KEY_SDLC_AGENTS_INDEX` | module configuration |
| `ARTIFACT_KEY_SDLC_AGENT_PLANNER` | module configuration |
| `ARTIFACT_KEY_SDLC_AGENT_TASK_DECOMPOSER` | module configuration |
| `ARTIFACT_KEY_SDLC_AGENT_IMPL_PLANNER` | module configuration |
| `ARTIFACT_KEY_SDLC_AGENT_EXECUTOR` | module configuration |
| `ARTIFACT_KEY_SDLC_AGENT_REVIEWER` | module configuration |
| `ARTIFACT_KEY_SDLC_AGENT_MEMORY_MANAGER` | module configuration |
| `ARTIFACT_KEY_SDLC_DELIVERY_STATUS_RULES` | module configuration |
| `ARTIFACT_KEY_SDLC_SCAFFOLD_PUBLISH_MANIFEST` | module configuration |
| `ARTIFACT_KEY_SDLC_SCAFFOLD_PUBLISH_MANIFEST_HISTORY` | module configuration |
| `ARTIFACT_KEY_SDLC_CURRENT_ROOT` | module configuration |
| `ARTIFACT_KEY_SDLC_HISTORY_ROOT` | module configuration |
...
| `ARTIFACT_KEY_LAYER1_RUNTIME_EVIDENCE` | module configuration |
