---
title: "Module Documentation: agent_runner_v2.operator_console.app1"
template_id: "CB-02"
version: "1.0.0"
doc_type: "system"
...
module_path: "agent_runner_v2/operator_console/app1.py"
module_area: "support"
documentation_mode: "summary"
owner_doc_path: "docs/repo/codebase/current/02_modules/agent-runner-v2-operator-console-app1.md"
...
# Module Documentation: agent_runner_v2.operator_console.app1
...
| `config` | external module | repository dependency |
| `services.backend_service` | external module | repository dependency |
| `services.runner_service` | external module | repository dependency |
...
**Purpose**: Launch the Agent Runner desktop operator console.
