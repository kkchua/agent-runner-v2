---
title: "Module Documentation: agent_runner_v2.runtime_utils"
template_id: "CB-02"
version: "1.0.0"
doc_type: "system"
...
module_path: "agent_runner_v2/runtime_utils.py"
module_area: "support"
documentation_mode: "summary"
owner_doc_path: "docs/repo/codebase/current/02_modules/agent-runner-v2-runtime-utils.md"
...
# Module Documentation: agent_runner_v2.runtime_utils
...
**Signature**: `safe_relative_to(path: Path, base: Path)`

**Purpose**: Safely compute relative path, falling back to os.path.relpath on Windows.
...
**Signature**: `save_json(path: Path, data: Any)`
