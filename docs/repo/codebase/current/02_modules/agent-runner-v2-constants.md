...
**Signature**: `extract_slug_from_path(file_path: str)`

**Purpose**: Extract the slug from an SDLC artifact filename.

**Parameters**:

| Name | Type | Default | Description |
|------|------|---------|-------------|
| `file_path` | `str` | -- | Path or filename string to extract the slug from. |
...
**Signature**: `extract_date_from_path(file_path: str)`

**Purpose**: Extract the date from an SDLC artifact filename.

**Parameters**:

| Name | Type | Default | Description |
|------|------|---------|-------------|
| `file_path` | `str` | -- | Path or filename string to extract the date from. |
