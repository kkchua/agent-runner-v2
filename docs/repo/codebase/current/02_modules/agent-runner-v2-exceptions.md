...
**Purpose**: Raised when configuration is invalid, missing, or inconsistent.

#### NotFoundError

**Inherits from**: `Exception`

**Purpose**: Raised when a required resource (file, directory, registry entry) is not found.
