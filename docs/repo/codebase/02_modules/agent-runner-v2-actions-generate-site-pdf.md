---
title: "Module Documentation: agent_runner_v2.actions.generate_site_pdf"
template_id: "CB-02"
status: "active"
module_path: "agent_runner_v2/actions/generate_site_pdf.py"
module_area: "actions"
documentation_mode: "full"
owner_doc_path: "docs/repo/codebase/02_modules/agent-runner-v2-actions-generate-site-pdf.md"
...
# Module Documentation: agent_runner_v2.actions.generate_site_pdf
...
**Signature**: `generate_site_pdf(*, context: dict[str, str], state: dict, step_cfg: dict, project_root: Path)`

**Purpose**: Convert HTML to PDF using weasyprint.
