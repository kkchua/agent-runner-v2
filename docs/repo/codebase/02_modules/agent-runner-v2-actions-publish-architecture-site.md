...
owner_doc_path: "docs/repo/codebase/02_modules/agent-runner-v2-actions-publish-architecture-site.md"
...
**Signature**: `publish_architecture_site(*, context: dict[str, str], state: dict, step_cfg: dict, project_root: Path)`
