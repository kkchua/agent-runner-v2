---
title: "Module Documentation: agent_runner_v2.actions.archive_previous_version"
template_id: "CB-02"
status: "active"
module_path: "agent_runner_v2/actions/archive_previous_version.py"
module_area: "actions"
documentation_mode: "full"
owner_doc_path: "docs/repo/codebase/02_modules/agent-runner-v2-actions-archive-previous-version.md"
...
# Module Documentation: agent_runner_v2.actions.archive_previous_version
...
**Signature**: `archive_previous_version(*, context: dict[str, str], state: dict, step_cfg: dict, project_root: Path)`

**Purpose**: Archive previous version of a file before regeneration.
...
| Name | Purpose |
|------|--------|
| `AUDIENCE_FILES` | module configuration |
