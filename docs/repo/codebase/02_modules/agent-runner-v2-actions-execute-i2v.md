---
title: "Module Documentation: agent_runner_v2.actions.execute_i2v"
template_id: "CB-02"
status: "active"
module_path: "agent_runner_v2/actions/execute_i2v.py"
module_area: "actions"
documentation_mode: "full"
owner_doc_path: "docs/repo/codebase/02_modules/agent-runner-v2-actions-execute-i2v.md"
...
# Module Documentation: agent_runner_v2.actions.execute_i2v
...
**Signature**: `execute_i2v(*, context: dict[str, str], state: dict, step_cfg: dict, project_root: Path)`

**Purpose**: Execute I2V generation for all scenes.
