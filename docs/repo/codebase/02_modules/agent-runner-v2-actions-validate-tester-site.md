---
title: "Module Documentation: agent_runner_v2.actions.validate_tester_site"
template_id: "CB-02"
status: "active"
module_path: "agent_runner_v2/actions/validate_tester_site.py"
module_area: "actions"
documentation_mode: "full"
owner_doc_path: "docs/repo/codebase/02_modules/agent-runner-v2-actions-validate-tester-site.md"
...
# Module Documentation: agent_runner_v2.actions.validate_tester_site
...
**Signature**: `validate_tester_site(*, context: dict[str, str], state: dict, step_cfg: dict, project_root: Path)`
