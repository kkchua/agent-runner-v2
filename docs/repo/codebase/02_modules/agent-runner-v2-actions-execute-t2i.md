---
title: "Module Documentation: agent_runner_v2.actions.execute_t2i"
template_id: "CB-02"
status: "active"
module_path: "agent_runner_v2/actions/execute_t2i.py"
module_area: "actions"
documentation_mode: "full"
owner_doc_path: "docs/repo/codebase/02_modules/agent-runner-v2-actions-execute-t2i.md"
...
# Module Documentation: agent_runner_v2.actions.execute_t2i
...
**Signature**: `execute_t2i(*, context: dict[str, str], state: dict, step_cfg: dict, project_root: Path)`

**Purpose**: Execute T2I generation for all scenes in VideoExpress workflow.
