...
owner_doc_path: "docs/repo/codebase/02_modules/agent-runner-v2-actions-validate-architecture-site.md"
...
**Signature**: `validate_architecture_site(*, context: dict[str, str], state: dict, step_cfg: dict, project_root: Path)`
