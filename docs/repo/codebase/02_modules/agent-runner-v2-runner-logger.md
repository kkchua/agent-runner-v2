...
owner_doc_path: "docs/repo/codebase/02_modules/agent-runner-v2-runner-logger.md"
...
**Signature**: `log_invocation_result(step: str, coder: str, *, model: str = '', model_id: str = '', connection: str = '', auth_type: str = '', return_code: int, duration_ms: int, status: str, message: str = '')`
