...
| `docs/repo/codebase/backups/BACKUP-20260723-205417/00_standards/CODEBASE_DOC_SOP.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/backups/BACKUP-20260723-205417/00_standards/CODEBASE_DOC_STATUS_RULES.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/backups/BACKUP-20260723-211659/00_standards/CODEBASE_DOC_SOP.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/backups/BACKUP-20260723-211659/00_standards/CODEBASE_DOC_STATUS_RULES.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/backups/BACKUP-20260723-212549/00_standards/CODEBASE_DOC_SOP.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/backups/BACKUP-20260723-212549/00_standards/CODEBASE_DOC_STATUS_RULES.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/backups/BACKUP-20260723-214114/00_standards/CODEBASE_DOC_SOP.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/backups/BACKUP-20260723-214114/00_standards/CODEBASE_DOC_STATUS_RULES.md` | modify | part of repository scan baseline | medium |
...
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/01_inventory/codebase_inventory.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-action-result.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-actions-copy-artifact.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-actions-documentation-validation-core.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-actions-finalize-bootstrap.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-actions-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-actions-promote-artifact.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-actions-promote-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-actions-scan-repo-codebase.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-actions-sdlc-shared-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-actions-step-completion.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-actions-sync-codebase-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-actions-sync-system-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-actions-validate-codebase-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-actions-validate-system-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-approve-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-artifact-keys.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-artifact-paths.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-backend-client.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-backend-execution.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-bootstrap-workflows-default-00-bootstrap-lifecycle-admin-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-bootstrap-workflows-default-00-bootstrap-lifecycle-admin-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-bootstrap-workflows-default-01-governance-foundation-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-bootstrap-workflows-default-01-governance-foundation-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-bootstrap-workflows-default-01-governance-foundation-v1-output-paths.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-bootstrap-workflows-default-02-agent-runner-platform-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-bootstrap-workflows-default-02-agent-runner-platform-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-bootstrap-workflows-default-02-agent-runner-platform-v1-output-paths.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-codebase-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-codebase-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-delivery-scaffold-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-delivery-scaffold-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-delivery-scaffold-v1-install.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-init-doc-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-10-requirement-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-20-planning-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-30-backlog-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-40-task-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-50-implementation-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-60-execution-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-70-validation-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-80-review-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-bundle-governance.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-bundle-loader.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-bundle-taxonomy.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-cleanup-generated-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-cli-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-codebase-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-codebase-init-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-coder-adapters.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-coder-registry.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-config-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-config-loader.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-config-section-requirements.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-console-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-constants-legacy-backup-20260717.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-constants.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-daemon-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-daemon.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-doc-paths.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-doc-text.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-documentation-guardrails.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-engine-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-exceptions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-execution-core.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-execution-request.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-execution-result.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-execution-support.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-failure-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-job-state.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-manual-runtime-deps.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-manual-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-notification-manager.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-notifications.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-operator-console-app.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-operator-console-app1.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-operator-console-config.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-operator-console-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-operator-console-models.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-operator-console-services-backend-service.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-operator-console-services-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-operator-console-services-runner-service.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-path-catalog.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-path-primitives.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-recovery-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-routing-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-run-agent.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-runner-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-runner-logger.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-runtime-context.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-runtime-utils.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-shared-runtime-deps.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-site-styles.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-state-defaults.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-step-execution-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-step-runner.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-stop-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-submit-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-submitter.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-sync-workflows.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-system-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-task-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-tools-agent-tools.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-transition-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-workflow-bundle-validate-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-workflow-bundle-validator.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-workflow-packages-actions-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-workflow-packages-base.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-workflow-packages-extensions-base.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-workflow-packages-hooks.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-workflow-packages-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-workflow-packages-loader.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-workflow-packages-registry.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-workflow-path-contracts.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-workflow-router.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-workflow-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-workflow-spec-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/02_modules/agent-runner-v2-workflow-specs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/03_components/actions-package.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/03_components/codebase-governance.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/03_components/config-and-data.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/03_components/scripts-suite.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/03_components/tests-suite.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/03_components/workflow-families.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/04_changes/SDLC00CB-20260723-6b49ca87-reconcile.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-6b49ca87/sync_logs/SYNC-SDLC00CB-20260723-6b49ca87.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/01_inventory/codebase_inventory.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-action-result.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-actions-copy-artifact.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-actions-documentation-validation-core.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-actions-finalize-bootstrap.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-actions-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-actions-promote-artifact.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-actions-promote-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-actions-scan-repo-codebase.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-actions-sdlc-shared-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-actions-step-completion.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-actions-sync-codebase-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-actions-sync-system-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-actions-validate-codebase-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-actions-validate-system-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-approve-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-artifact-keys.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-artifact-paths.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-backend-client.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-backend-execution.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-bootstrap-workflows-default-00-bootstrap-lifecycle-admin-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-bootstrap-workflows-default-00-bootstrap-lifecycle-admin-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-bootstrap-workflows-default-01-governance-foundation-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-bootstrap-workflows-default-01-governance-foundation-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-bootstrap-workflows-default-01-governance-foundation-v1-output-paths.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-bootstrap-workflows-default-02-agent-runner-platform-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-bootstrap-workflows-default-02-agent-runner-platform-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-bootstrap-workflows-default-02-agent-runner-platform-v1-output-paths.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-codebase-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-codebase-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-delivery-scaffold-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-delivery-scaffold-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-delivery-scaffold-v1-install.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-init-doc-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-10-requirement-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-20-planning-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-30-backlog-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-40-task-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-50-implementation-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-60-execution-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-70-validation-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-80-review-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-bundle-governance.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-bundle-loader.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-bundle-taxonomy.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-cleanup-generated-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-cli-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-codebase-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-codebase-init-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-coder-adapters.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-coder-registry.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-config-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-config-loader.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-config-section-requirements.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-console-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-constants-legacy-backup-20260717.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-constants.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-daemon-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-daemon.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-doc-paths.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-doc-text.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-documentation-guardrails.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-engine-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-exceptions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-execution-core.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-execution-request.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-execution-result.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-execution-support.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-failure-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-job-state.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-manual-runtime-deps.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-manual-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-notification-manager.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-notifications.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-operator-console-app.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-operator-console-app1.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-operator-console-config.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-operator-console-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-operator-console-models.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-operator-console-services-backend-service.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-operator-console-services-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-operator-console-services-runner-service.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-path-catalog.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-path-primitives.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-recovery-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-routing-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-run-agent.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-runner-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-runner-logger.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-runtime-context.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-runtime-utils.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-shared-runtime-deps.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-site-styles.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-state-defaults.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-step-execution-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-step-runner.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-stop-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-submit-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-submitter.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-sync-workflows.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-system-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-task-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-tools-agent-tools.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-transition-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-workflow-bundle-validate-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-workflow-bundle-validator.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-workflow-packages-actions-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-workflow-packages-base.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-workflow-packages-extensions-base.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-workflow-packages-hooks.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-workflow-packages-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-workflow-packages-loader.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-workflow-packages-registry.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-workflow-path-contracts.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-workflow-router.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-workflow-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-workflow-spec-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/02_modules/agent-runner-v2-workflow-specs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/03_components/actions-package.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/03_components/codebase-governance.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/03_components/config-and-data.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/03_components/scripts-suite.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/03_components/tests-suite.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/03_components/workflow-families.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/04_changes/SDLC00CB-20260723-786ab7b6-reconcile.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/sync_logs/SDLC00CB-20260723-786ab7b6-review.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/sync_logs/SDLC00CB-20260723-786ab7b6-review.meta.json` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-786ab7b6/sync_logs/SYNC-SDLC00CB-20260723-786ab7b6.md` | modify | part of repository scan baseline | medium |
...
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/01_inventory/codebase_inventory.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/01_inventory/codebase_inventory.meta.json` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-action-result.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-actions-copy-artifact.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-actions-documentation-validation-core.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-actions-finalize-bootstrap.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-actions-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-actions-promote-artifact.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-actions-promote-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-actions-scan-repo-codebase.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-actions-sdlc-shared-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-actions-step-completion.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-actions-sync-codebase-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-actions-sync-system-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-actions-validate-codebase-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-actions-validate-system-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-approve-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-artifact-keys.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-artifact-paths.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-backend-client.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-backend-execution.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-bootstrap-workflows-default-00-bootstrap-lifecycle-admin-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-bootstrap-workflows-default-00-bootstrap-lifecycle-admin-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-bootstrap-workflows-default-01-governance-foundation-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-bootstrap-workflows-default-01-governance-foundation-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-bootstrap-workflows-default-01-governance-foundation-v1-output-paths.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-bootstrap-workflows-default-02-agent-runner-platform-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-bootstrap-workflows-default-02-agent-runner-platform-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-bootstrap-workflows-default-02-agent-runner-platform-v1-output-paths.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-codebase-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-codebase-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-delivery-scaffold-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-delivery-scaffold-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-delivery-scaffold-v1-install.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-init-doc-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-10-requirement-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-20-planning-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-30-backlog-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-40-task-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-50-implementation-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-60-execution-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-70-validation-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-80-review-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-bundle-governance.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-bundle-loader.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-bundle-taxonomy.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-cleanup-generated-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-cli-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-codebase-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-codebase-init-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-coder-adapters.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-coder-registry.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-config-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-config-loader.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-config-section-requirements.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-console-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-constants-legacy-backup-20260717.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-constants.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-daemon-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-daemon.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-doc-paths.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-documentation-guardrails.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-engine-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-exceptions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-execution-core.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-execution-request.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-execution-result.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-execution-support.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-failure-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-job-state.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-manual-runtime-deps.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-manual-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-notification-manager.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-notifications.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-operator-console-app.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-operator-console-app1.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-operator-console-config.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-operator-console-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-operator-console-models.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-operator-console-services-backend-service.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-operator-console-services-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-operator-console-services-runner-service.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-path-catalog.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-path-primitives.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-recovery-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-routing-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-run-agent.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-runner-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-runner-logger.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-runtime-context.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-runtime-utils.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-shared-runtime-deps.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-site-styles.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-state-defaults.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-step-execution-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-step-runner.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-stop-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-submit-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-submitter.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-sync-workflows.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-system-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-task-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-tools-agent-tools.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-transition-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-workflow-bundle-validate-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-workflow-bundle-validator.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-workflow-packages-actions-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-workflow-packages-base.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-workflow-packages-extensions-base.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-workflow-packages-hooks.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-workflow-packages-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-workflow-packages-loader.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-workflow-packages-registry.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-workflow-path-contracts.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-workflow-router.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-workflow-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-workflow-spec-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/02_modules/agent-runner-v2-workflow-specs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/03_components/actions-package.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/03_components/codebase-governance.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/03_components/config-and-data.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/03_components/scripts-suite.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/03_components/tests-suite.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/03_components/workflow-families.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/04_changes/SDLC00CB-20260723-c66bc6aa-reconcile.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/sync_logs/SDLC00CB-20260723-c66bc6aa-review.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-c66bc6aa/sync_logs/SYNC-SDLC00CB-20260723-c66bc6aa.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/01_inventory/codebase_inventory.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-action-result.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-actions-copy-artifact.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-actions-documentation-validation-core.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-actions-finalize-bootstrap.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-actions-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-actions-promote-artifact.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-actions-promote-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-actions-scan-repo-codebase.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-actions-sdlc-shared-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-actions-step-completion.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-actions-sync-codebase-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-actions-sync-system-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-actions-validate-codebase-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-actions-validate-system-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-approve-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-artifact-keys.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-artifact-paths.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-backend-client.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-backend-execution.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-bootstrap-workflows-default-00-bootstrap-lifecycle-admin-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-bootstrap-workflows-default-00-bootstrap-lifecycle-admin-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-bootstrap-workflows-default-01-governance-foundation-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-bootstrap-workflows-default-01-governance-foundation-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-bootstrap-workflows-default-01-governance-foundation-v1-output-paths.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-bootstrap-workflows-default-02-agent-runner-platform-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-bootstrap-workflows-default-02-agent-runner-platform-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-bootstrap-workflows-default-02-agent-runner-platform-v1-output-paths.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-codebase-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-codebase-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-delivery-scaffold-v1-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-delivery-scaffold-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-delivery-scaffold-v1-install.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-init-doc-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-10-requirement-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-20-planning-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-30-backlog-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-40-task-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-50-implementation-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-60-execution-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-70-validation-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-80-review-v1-context-extensions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-bundle-governance.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-bundle-loader.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-bundle-taxonomy.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-cleanup-generated-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-cli-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-codebase-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-codebase-init-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-coder-adapters.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-coder-registry.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-config-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-config-loader.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-config-section-requirements.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-console-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-constants-legacy-backup-20260717.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-constants.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-daemon-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-daemon.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-doc-paths.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-doc-text.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-documentation-guardrails.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-engine-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-exceptions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-execution-core.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-execution-request.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-execution-result.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-execution-support.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-failure-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-job-state.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-manual-runtime-deps.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-manual-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-notification-manager.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-notifications.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-operator-console-app.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-operator-console-app1.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-operator-console-config.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-operator-console-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-operator-console-models.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-operator-console-services-backend-service.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-operator-console-services-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-operator-console-services-runner-service.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-path-catalog.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-path-primitives.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-recovery-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-routing-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-run-agent.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-runner-actions.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-runner-logger.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-runtime-context.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-runtime-utils.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-shared-runtime-deps.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-site-styles.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-state-defaults.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-step-execution-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-step-runner.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-stop-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-submit-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-submitter.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-sync-workflows.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-system-docs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-task-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-tools-agent-tools.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-transition-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-workflow-bundle-validate-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-workflow-bundle-validator.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-workflow-packages-actions-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-workflow-packages-base.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-workflow-packages-extensions-base.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-workflow-packages-hooks.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-workflow-packages-init.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-workflow-packages-loader.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-workflow-packages-registry.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-workflow-path-contracts.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-workflow-router.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-workflow-runtime.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-workflow-spec-commands.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/02_modules/agent-runner-v2-workflow-specs.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/03_components/actions-package.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/03_components/codebase-governance.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/03_components/config-and-data.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/03_components/scripts-suite.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/03_components/tests-suite.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/03_components/workflow-families.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/04_changes/SDLC00CB-20260723-d46af7f2-reconcile.md` | modify | part of repository scan baseline | medium |
| `docs/repo/codebase/runs/SDLC00CB-20260723-d46af7f2/sync_logs/SYNC-SDLC00CB-20260723-d46af7f2.md` | modify | part of repository scan baseline | medium |
...
|----------|------|------|--------|
| `codebase_inventory.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/01_inventory/codebase_inventory.md` | module/component/inventory | draft |
| `agent-runner-v2-init.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-init.md` | module/component/inventory | draft |
| `agent-runner-v2-action-result.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-action-result.md` | module/component/inventory | draft |
| `agent-runner-v2-actions-init.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-actions-init.md` | module/component/inventory | draft |
| `agent-runner-v2-actions-copy-artifact.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-actions-copy-artifact.md` | module/component/inventory | draft |
| `agent-runner-v2-actions-documentation-validation-core.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-actions-documentation-validation-core.md` | module/component/inventory | draft |
| `agent-runner-v2-actions-finalize-bootstrap.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-actions-finalize-bootstrap.md` | module/component/inventory | draft |
| `agent-runner-v2-actions-promote-artifact.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-actions-promote-artifact.md` | module/component/inventory | draft |
| `agent-runner-v2-actions-promote-init.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-actions-promote-init.md` | module/component/inventory | draft |
| `agent-runner-v2-actions-scan-repo-codebase.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-actions-scan-repo-codebase.md` | module/component/inventory | draft |
| `agent-runner-v2-actions-sdlc-shared-actions.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-actions-sdlc-shared-actions.md` | module/component/inventory | draft |
| `agent-runner-v2-actions-step-completion.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-actions-step-completion.md` | module/component/inventory | draft |
| `agent-runner-v2-actions-sync-codebase-docs.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-actions-sync-codebase-docs.md` | module/component/inventory | draft |
| `agent-runner-v2-actions-sync-system-docs.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-actions-sync-system-docs.md` | module/component/inventory | draft |
| `agent-runner-v2-actions-validate-codebase-docs.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-actions-validate-codebase-docs.md` | module/component/inventory | draft |
| `agent-runner-v2-actions-validate-system-docs.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-actions-validate-system-docs.md` | module/component/inventory | draft |
| `agent-runner-v2-approve-commands.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-approve-commands.md` | module/component/inventory | draft |
| `agent-runner-v2-artifact-keys.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-artifact-keys.md` | module/component/inventory | draft |
| `agent-runner-v2-artifact-paths.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-artifact-paths.md` | module/component/inventory | draft |
| `agent-runner-v2-backend-client.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-backend-client.md` | module/component/inventory | draft |
| `agent-runner-v2-backend-execution.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-backend-execution.md` | module/component/inventory | draft |
| `agent-runner-v2-bootstrap-workflows-default-00-bootstrap-lifecycle-admin-v1-actions.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-bootstrap-workflows-default-00-bootstrap-lifecycle-admin-v1-actions.md` | module/component/inventory | draft |
| `agent-runner-v2-bootstrap-workflows-default-00-bootstrap-lifecycle-admin-v1-context-extensions.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-bootstrap-workflows-default-00-bootstrap-lifecycle-admin-v1-context-extensions.md` | module/component/inventory | draft |
| `agent-runner-v2-bootstrap-workflows-default-01-governance-foundation-v1-actions.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-bootstrap-workflows-default-01-governance-foundation-v1-actions.md` | module/component/inventory | draft |
| `agent-runner-v2-bootstrap-workflows-default-01-governance-foundation-v1-context-extensions.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-bootstrap-workflows-default-01-governance-foundation-v1-context-extensions.md` | module/component/inventory | draft |
| `agent-runner-v2-bootstrap-workflows-default-01-governance-foundation-v1-output-paths.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-bootstrap-workflows-default-01-governance-foundation-v1-output-paths.md` | module/component/inventory | draft |
| `agent-runner-v2-bootstrap-workflows-default-02-agent-runner-platform-v1-actions.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-bootstrap-workflows-default-02-agent-runner-platform-v1-actions.md` | module/component/inventory | draft |
| `agent-runner-v2-bootstrap-workflows-default-02-agent-runner-platform-v1-context-extensions.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-bootstrap-workflows-default-02-agent-runner-platform-v1-context-extensions.md` | module/component/inventory | draft |
| `agent-runner-v2-bootstrap-workflows-default-02-agent-runner-platform-v1-output-paths.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-bootstrap-workflows-default-02-agent-runner-platform-v1-output-paths.md` | module/component/inventory | draft |
| `agent-runner-v2-bootstrap-workflows-default-sdlc-00-codebase-v1-actions.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-codebase-v1-actions.md` | module/component/inventory | draft |
| `agent-runner-v2-bootstrap-workflows-default-sdlc-00-codebase-v1-context-extensions.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-codebase-v1-context-extensions.md` | module/component/inventory | draft |
| `agent-runner-v2-bootstrap-workflows-default-sdlc-00-delivery-scaffold-v1-actions.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-delivery-scaffold-v1-actions.md` | module/component/inventory | draft |
| `agent-runner-v2-bootstrap-workflows-default-sdlc-00-delivery-scaffold-v1-context-extensions.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-delivery-scaffold-v1-context-extensions.md` | module/component/inventory | draft |
| `agent-runner-v2-bootstrap-workflows-default-sdlc-00-delivery-scaffold-v1-install.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-delivery-scaffold-v1-install.md` | module/component/inventory | draft |
| `agent-runner-v2-bootstrap-workflows-default-sdlc-00-init-doc-v1-context-extensions.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-00-init-doc-v1-context-extensions.md` | module/component/inventory | draft |
| `agent-runner-v2-bootstrap-workflows-default-sdlc-10-requirement-v1-context-extensions.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-10-requirement-v1-context-extensions.md` | module/component/inventory | draft |
| `agent-runner-v2-bootstrap-workflows-default-sdlc-20-planning-v1-context-extensions.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-20-planning-v1-context-extensions.md` | module/component/inventory | draft |
| `agent-runner-v2-bootstrap-workflows-default-sdlc-30-backlog-v1-context-extensions.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-30-backlog-v1-context-extensions.md` | module/component/inventory | draft |
| `agent-runner-v2-bootstrap-workflows-default-sdlc-40-task-v1-context-extensions.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-40-task-v1-context-extensions.md` | module/component/inventory | draft |
| `agent-runner-v2-bootstrap-workflows-default-sdlc-50-implementation-v1-context-extensions.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-50-implementation-v1-context-extensions.md` | module/component/inventory | draft |
| `agent-runner-v2-bootstrap-workflows-default-sdlc-60-execution-v1-context-extensions.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-60-execution-v1-context-extensions.md` | module/component/inventory | draft |
| `agent-runner-v2-bootstrap-workflows-default-sdlc-70-validation-v1-context-extensions.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-70-validation-v1-context-extensions.md` | module/component/inventory | draft |
| `agent-runner-v2-bootstrap-workflows-default-sdlc-80-review-v1-context-extensions.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-bootstrap-workflows-default-sdlc-80-review-v1-context-extensions.md` | module/component/inventory | draft |
| `agent-runner-v2-bundle-governance.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-bundle-governance.md` | module/component/inventory | draft |
| `agent-runner-v2-bundle-loader.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-bundle-loader.md` | module/component/inventory | draft |
| `agent-runner-v2-bundle-taxonomy.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-bundle-taxonomy.md` | module/component/inventory | draft |
| `agent-runner-v2-cleanup-generated-docs.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-cleanup-generated-docs.md` | module/component/inventory | draft |
| `agent-runner-v2-cli-runtime.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-cli-runtime.md` | module/component/inventory | draft |
| `agent-runner-v2-codebase-docs.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-codebase-docs.md` | module/component/inventory | draft |
| `agent-runner-v2-codebase-init-commands.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-codebase-init-commands.md` | module/component/inventory | draft |
| `agent-runner-v2-coder-adapters.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-coder-adapters.md` | module/component/inventory | draft |
| `agent-runner-v2-coder-registry.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-coder-registry.md` | module/component/inventory | draft |
| `agent-runner-v2-config-init.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-config-init.md` | module/component/inventory | draft |
| `agent-runner-v2-config-section-requirements.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-config-section-requirements.md` | module/component/inventory | draft |
| `agent-runner-v2-config-loader.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-config-loader.md` | module/component/inventory | draft |
| `agent-runner-v2-console-commands.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-console-commands.md` | module/component/inventory | draft |
| `agent-runner-v2-constants.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-constants.md` | module/component/inventory | draft |
| `agent-runner-v2-constants-legacy-backup-20260717.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-constants-legacy-backup-20260717.md` | module/component/inventory | draft |
| `agent-runner-v2-daemon.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-daemon.md` | module/component/inventory | draft |
| `agent-runner-v2-daemon-runtime.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-daemon-runtime.md` | module/component/inventory | draft |
| `agent-runner-v2-doc-paths.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-doc-paths.md` | module/component/inventory | draft |
| `agent-runner-v2-doc-text.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-doc-text.md` | module/component/inventory | draft |
| `agent-runner-v2-documentation-guardrails.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-documentation-guardrails.md` | module/component/inventory | draft |
| `agent-runner-v2-engine-commands.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-engine-commands.md` | module/component/inventory | draft |
| `agent-runner-v2-exceptions.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-exceptions.md` | module/component/inventory | draft |
| `agent-runner-v2-execution-core.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-execution-core.md` | module/component/inventory | draft |
| `agent-runner-v2-execution-request.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-execution-request.md` | module/component/inventory | draft |
| `agent-runner-v2-execution-result.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-execution-result.md` | module/component/inventory | draft |
| `agent-runner-v2-execution-support.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-execution-support.md` | module/component/inventory | draft |
| `agent-runner-v2-failure-runtime.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-failure-runtime.md` | module/component/inventory | draft |
| `agent-runner-v2-job-state.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-job-state.md` | module/component/inventory | draft |
| `agent-runner-v2-manual-runtime.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-manual-runtime.md` | module/component/inventory | draft |
| `agent-runner-v2-manual-runtime-deps.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-manual-runtime-deps.md` | module/component/inventory | draft |
| `agent-runner-v2-notification-manager.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-notification-manager.md` | module/component/inventory | draft |
| `agent-runner-v2-notifications.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-notifications.md` | module/component/inventory | draft |
| `agent-runner-v2-operator-console-init.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-operator-console-init.md` | module/component/inventory | draft |
| `agent-runner-v2-operator-console-app.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-operator-console-app.md` | module/component/inventory | draft |
| `agent-runner-v2-operator-console-app1.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-operator-console-app1.md` | module/component/inventory | draft |
| `agent-runner-v2-operator-console-config.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-operator-console-config.md` | module/component/inventory | draft |
| `agent-runner-v2-operator-console-models.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-operator-console-models.md` | module/component/inventory | draft |
| `agent-runner-v2-operator-console-services-init.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-operator-console-services-init.md` | module/component/inventory | draft |
| `agent-runner-v2-operator-console-services-backend-service.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-operator-console-services-backend-service.md` | module/component/inventory | draft |
| `agent-runner-v2-operator-console-services-runner-service.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-operator-console-services-runner-service.md` | module/component/inventory | draft |
| `agent-runner-v2-path-catalog.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-path-catalog.md` | module/component/inventory | draft |
| `agent-runner-v2-path-primitives.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-path-primitives.md` | module/component/inventory | draft |
| `agent-runner-v2-recovery-runtime.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-recovery-runtime.md` | module/component/inventory | draft |
| `agent-runner-v2-routing-runtime.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-routing-runtime.md` | module/component/inventory | draft |
| `agent-runner-v2-run-agent.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-run-agent.md` | module/component/inventory | draft |
| `agent-runner-v2-runner-actions.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-runner-actions.md` | module/component/inventory | draft |
| `agent-runner-v2-runner-logger.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-runner-logger.md` | module/component/inventory | draft |
| `agent-runner-v2-runtime-context.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-runtime-context.md` | module/component/inventory | draft |
| `agent-runner-v2-runtime-utils.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-runtime-utils.md` | module/component/inventory | draft |
| `agent-runner-v2-shared-runtime-deps.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-shared-runtime-deps.md` | module/component/inventory | draft |
| `agent-runner-v2-site-styles.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-site-styles.md` | module/component/inventory | draft |
| `agent-runner-v2-state-defaults.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-state-defaults.md` | module/component/inventory | draft |
| `agent-runner-v2-step-execution-runtime.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-step-execution-runtime.md` | module/component/inventory | draft |
| `agent-runner-v2-step-runner.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-step-runner.md` | module/component/inventory | draft |
| `agent-runner-v2-stop-commands.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-stop-commands.md` | module/component/inventory | draft |
| `agent-runner-v2-submit-commands.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-submit-commands.md` | module/component/inventory | draft |
| `agent-runner-v2-submitter.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-submitter.md` | module/component/inventory | draft |
| `agent-runner-v2-sync-workflows.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-sync-workflows.md` | module/component/inventory | draft |
| `agent-runner-v2-system-docs.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-system-docs.md` | module/component/inventory | draft |
| `agent-runner-v2-task-runtime.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-task-runtime.md` | module/component/inventory | draft |
| `agent-runner-v2-tools-agent-tools.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-tools-agent-tools.md` | module/component/inventory | draft |
| `agent-runner-v2-transition-runtime.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-transition-runtime.md` | module/component/inventory | draft |
| `agent-runner-v2-workflow-bundle-validate-commands.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-workflow-bundle-validate-commands.md` | module/component/inventory | draft |
| `agent-runner-v2-workflow-bundle-validator.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-workflow-bundle-validator.md` | module/component/inventory | draft |
| `agent-runner-v2-workflow-packages-init.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-workflow-packages-init.md` | module/component/inventory | draft |
| `agent-runner-v2-workflow-packages-actions-init.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-workflow-packages-actions-init.md` | module/component/inventory | draft |
| `agent-runner-v2-workflow-packages-base.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-workflow-packages-base.md` | module/component/inventory | draft |
| `agent-runner-v2-workflow-packages-extensions-base.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-workflow-packages-extensions-base.md` | module/component/inventory | draft |
| `agent-runner-v2-workflow-packages-hooks.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-workflow-packages-hooks.md` | module/component/inventory | draft |
| `agent-runner-v2-workflow-packages-loader.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-workflow-packages-loader.md` | module/component/inventory | draft |
| `agent-runner-v2-workflow-packages-registry.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-workflow-packages-registry.md` | module/component/inventory | draft |
| `agent-runner-v2-workflow-path-contracts.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-workflow-path-contracts.md` | module/component/inventory | draft |
| `agent-runner-v2-workflow-router.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-workflow-router.md` | module/component/inventory | draft |
| `agent-runner-v2-workflow-runtime.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-workflow-runtime.md` | module/component/inventory | draft |
| `agent-runner-v2-workflow-spec-commands.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-workflow-spec-commands.md` | module/component/inventory | draft |
| `agent-runner-v2-workflow-specs.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-workflow-specs.md` | module/component/inventory | draft |
| `workflow-families.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/03_components/workflow-families.md` | module/component/inventory | draft |
| `actions-package.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/03_components/actions-package.md` | module/component/inventory | draft |
| `tests-suite.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/03_components/tests-suite.md` | module/component/inventory | draft |
| `scripts-suite.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/03_components/scripts-suite.md` | module/component/inventory | draft |
| `config-and-data.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/03_components/config-and-data.md` | module/component/inventory | draft |
| `codebase-governance.md` | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/03_components/codebase-governance.md` | module/component/inventory | draft |
...
|--------|----------------|------------|----------------|
| `codebase_inventory.md` | undocumented | current | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/01_inventory/codebase_inventory.md` |
| `agent-runner-v2-init.md` | undocumented | current | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-init.md` |
| `agent-runner-v2-action-result.md` | undocumented | current | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-action-result.md` |
| `agent-runner-v2-actions-init.md` | undocumented | current | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-actions-init.md` |
| `agent-runner-v2-actions-copy-artifact.md` | undocumented | current | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-actions-copy-artifact.md` |
| `agent-runner-v2-actions-documentation-validation-core.md` | undocumented | current | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-actions-documentation-validation-core.md` |
| `agent-runner-v2-actions-finalize-bootstrap.md` | undocumented | current | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-actions-finalize-bootstrap.md` |
| `agent-runner-v2-actions-promote-artifact.md` | undocumented | current | `docs/repo/codebase/runs/SDLC00CB-20260723-e1c86100/02_modules/agent-runner-v2-actions-promote-artifact.md` |
