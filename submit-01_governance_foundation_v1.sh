#!/usr/bin/env bash
# submit-01_governance_foundation_v1.sh - Edit the variables below, then run.
#
# Submits a new backend job for the 01_governance_foundation_v1 workflow:
#   ukbe-run-agent submit --workflow-name 01_governance_foundation_v1 ...
