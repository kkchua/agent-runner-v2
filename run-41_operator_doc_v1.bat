@echo off
REM run-41_operator_doc_v1.bat - Generate operator documentation markdown
REM
REM This workflow generates markdown content for the operator documentation site.
...
set "TEMPLATE_GROUP=41_operator_doc_v1"
...
set "JOB_ID=41OPS-GEN-20260705-001"
