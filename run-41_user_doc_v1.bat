@echo off
REM run-41_user_doc_v1.bat - Generate user documentation markdown
REM
REM This workflow generates markdown content for the user documentation site.
...
set "TEMPLATE_GROUP=41_user_doc_v1"
...
set "JOB_ID=41USER-GEN-20260705-001"
